  ...
  SELECT @PREFIXFORMAT=CTLTEXT FROM SFLADMINDB..SOFTCONTROL WHERE CTLID='BILLPREFIX_FORMAT'  
  ...
  SELECT @TBILLPREFIX =CTLTEXT FROM SFLADMINDB..SOFTCONTROL WHERE CTLID='BILL_PREFIX'  
  IF @PREFIXFORMAT='3'  
  BEGIN  
