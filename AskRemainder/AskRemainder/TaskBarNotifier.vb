...
#Region "Protected Members"
    ...
    Protected _fntTitleNormal As Font = New Font("TAHOMA", 14, FontStyle.Bold, GraphicsUnit.Pixel)
    Protected _fntTitleHover As Font = New Font("TAHOMA", 14, FontStyle.Underline, GraphicsUnit.Pixel)
    Protected _fntTextNormal As Font = New Font("TAHOMA", 12, FontStyle.Bold, GraphicsUnit.Pixel)
    Protected _fntTextHover As Font = New Font("TAHOMA", 12, FontStyle.Underline, GraphicsUnit.Pixel)
            ...
            Case TaskbarStates.Disappearing
                ...
                Else
                    ...
                    Else
                        Hide()
                        If Height = 2 Then
                            ''''''''''''''''' NEWLY '''''''''''''''''''''''''''''''Code used for Process Kill
                            Me.Close()
                            Me.Dispose()
                            For Each p As Process In System.Diagnostics.Process.GetProcessesByName("AskRemainder")
                                Try
                                    p.Kill()
                                    p.WaitForExit()
...
#Region "Overriden Base Class Methods"
    ...
    Protected Overrides Sub OnMouseUp(ByVal e As MouseEventArgs)
        ...
        If Me._bMouseOverClose Then
            ...
            'CLOSE BUTTON
            '''''''''''''''''''''''''''' KILL PROCESS NEWLY ADD
            'Example Process Kill
            'For Each p As Process In System.Diagnostics.Process.GetProcessesByName("notepad")
            '    Try
            '        p.Kill()
            '        p.WaitForExit()
            '    Catch ex As Exception
...
#Region "Add Control Newly"
    Public Sub AddControlToListbox1(ByVal image As Image, ByVal transparencyColor As Color, ByVal position As Point, ByVal dt As DataTable, ByVal flag As Boolean)
        'Dim TextBox1 As New TextBox
        'TextBox1.ForeColor = System.Drawing.Color.Black
        ''TextBox1.Location = New System.Drawing.Point(106, 48)
        'TextBox1.Location = position
        ...
        Lsbx.Location = position
        Lsbx.Size = New System.Drawing.Size(150, 250)
        Lsbx.Name = "Order No"
        Controls.Add(Lsbx)
        Lsbx.DataSource = dt
        Lsbx.DisplayMember = "ORNO"
        Lsbx.ValueMember = "ORNO"
        Lsbx.Visible = flag
    End Sub
    Public Sub AddControlToListbox2(ByVal image As Image, ByVal transparencyColor As Color, ByVal position As Point, ByVal dt As DataTable, ByVal flag As Boolean)
        Dim Lsbx As New ListBox
        Lsbx.Location = position
        Lsbx.Size = New System.Drawing.Size(150, 250)
        Lsbx.Name = "Customer Name"
        Controls.Add(Lsbx)
        Lsbx.DataSource = dt
        Lsbx.DisplayMember = "PNAME"
        Lsbx.ValueMember = "ORNO"
        Lsbx.Visible = flag
    End Sub

    Public Sub AddControlToListbox3(ByVal image As Image, ByVal transparencyColor As Color, ByVal position As Point, ByVal dt As DataTable, ByVal flag As Boolean)
        Dim Lsbx As New ListBox
        Lsbx.Location = position
        Lsbx.Size = New System.Drawing.Size(150, 250)
        Lsbx.Name = "Customer Mobile No"
        Controls.Add(Lsbx)
        Lsbx.DataSource = dt
        Lsbx.DisplayMember = "MOBILE"
        Lsbx.ValueMember = "ORNO"
        Lsbx.Visible = flag
    End Sub
    Public Sub AddControlToLabel1(ByVal image As Image, ByVal transparencyColor As Color, ByVal position As Point, ByVal flag As Boolean)
        Dim lbl1 As New Label
        lbl1.Location = position
        lbl1.Size = New System.Drawing.Size(150, 13)
        lbl1.Name = "lblOrder"
        lbl1.Text = "Order No"
    ...
    Public Sub AddControlToLabel2(ByVal image As Image, ByVal transparencyColor As Color, ByVal position As Point, ByVal flag As Boolean)
        Dim lbl1 As New Label
        lbl1.Location = position
        lbl1.Size = New System.Drawing.Size(150, 13)
        lbl1.Name = "lblCustomer"
    ...
    Public Sub AddControlToLabel3(ByVal image As Image, ByVal transparencyColor As Color, ByVal position As Point, ByVal flag As Boolean)
        Dim lbl1 As New Label
        lbl1.Location = position
        lbl1.Size = New System.Drawing.Size(150, 13)
        lbl1.Name = "lblMobile"
    ...
    Public Sub AddControlToGridView1(ByVal Image As Image, ByVal transparencyColor As Color, ByVal position As Point, ByVal dt As DataTable, ByVal flag As Boolean)
        Dim gridview As New DataGridView
        gridview.Location = position
        gridview.Size = New System.Drawing.Size(460, 225)
        gridview.Name = "gridviewOutStandingSummary"
        ...
        gridview.Visible = flag
        gridview.DataSource = dt
        For cnt As Integer = 0 To gridview.ColumnCount - 1
            gridview.Columns(cnt).SortMode = DataGridViewColumnSortMode.NotSortable
        Next
        For i As Integer = 0 To gridview.Rows.Count - 1
            If gridview.Rows(i).Cells("RUNNO").Value = "TOTAL" Then
                'Particular cells
                'gridview.Rows(i).Cells("DIASIZE").Style.BackColor = Color.DarkBlue
                'All Cells
        ...
        gridview.Columns("RUNNO1").Visible = False
        ...
        gridview.Columns("TRANNO").Width = 30
        gridview.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill
        'gridview.Columns("RESULT").Width = 15
        'gridview.Columns("MOBILENO").Width = 30
    ...
    Public Sub AddControlToGridView2(ByVal Image As Image, ByVal transparencyColor As Color, ByVal position As Point, ByVal dt As DataTable, ByVal flag As Boolean)
        Dim gridview As New DataGridView
        With gridview
            .Location = position
            .Size = New System.Drawing.Size(460, 225)
            gridview.Name = "gridviewStockSummary"
        ...
        gridview.Columns("RESULT").Visible = False
        'gridview.Columns("REORDPCS").HeaderText = "REORDER_PCS"
        'gridview.Columns("REORDWT").HeaderText = "REORDER_WT"
        'gridview.Columns("STKPCS").HeaderText = "STOCK_PCS"
        'gridview.Columns("STKWT").HeaderText = "STOCK_WT"
        gridview.Columns("SDIFFPCS").HeaderText = "SHORT_PCS"
        gridview.Columns("SDIFFWT").HeaderText = "SHORT_WT"
        gridview.Columns("EDIFFPCS").HeaderText = "EXCESS_PCS"
        gridview.Columns("EDIFFWT").HeaderText = "EXCESS_WT"
        gridview.Columns("SUBITEMNAME").HeaderText = "PARTICULARS"
            ...
            With dgvRow
                Select Case .Cells("COLHEAD").Value.ToString
                    Case "T"
                        ...
                        .DefaultCellStyle.Font = New Font("VERDHANA", 9, FontStyle.Bold)
                    Case "G"
                        .DefaultCellStyle.BackColor = Color.LightGoldenrodYellow
                        .DefaultCellStyle.ForeColor = Color.Green
                        .DefaultCellStyle.Font = New Font("VERDHANA", 9, FontStyle.Bold)
    ...
    End Sub
    Public Sub AddControlToGridView3(ByVal Image As Image, ByVal transparencyColor As Color, ByVal position As Point, ByVal dt As DataTable, ByVal flag As Boolean)
        Dim gridview As New DataGridView
        With gridview
            .Location = position
            .Size = New System.Drawing.Size(460, 225)
        ...
        For cnt As Integer = 0 To gridview.ColumnCount - 1
            ...
            End If
        Next
        gridview.Columns("REMDATE").Visible = False
        gridview.Columns("DUEDATE").Visible = False
        gridview.Columns("MOBILE").Visible = False
        'gridview.Columns("REORDPCS").HeaderText = "REORDER_PCS"
        'gridview.Columns("REORDWT").HeaderText = "REORDER_WT"
        'gridview.Columns("STKPCS").HeaderText = "STOCK_PCS"
        'gridview.Columns("STKWT").HeaderText = "STOCK_WT"
        gridview.Columns("PNAME").HeaderText = "CUSTOMERNAME"
        gridview.Columns("DESIGNERNAME").HeaderText = "SMITHNAME"
    ...
    Private GridView4DaTa As New DataTable
    Dim gridview As New DataGridView

    Friend WithEvents cmbItem4 As New System.Windows.Forms.ComboBox
    Friend WithEvents cmbSubItem4 As New System.Windows.Forms.ComboBox
    Friend WithEvents cmbRange4 As New System.Windows.Forms.ComboBox

    Private Sub cmbItemSelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs) Handles cmbItem4.SelectedIndexChanged, cmbSubItem4.SelectedIndexChanged, cmbRange4.SelectedIndexChanged
        If GridView4DaTa.Rows.Count = 0 Then
            Exit Sub
        End If
        GridView4DaTa.DefaultView.RowFilter = Nothing
        Dim RowFilter As String = Nothing
        If cmbItem4.Text.ToUpper <> "ALL" Then
            If Not RowFilter = Nothing Then
                RowFilter += " AND"
            End If
            RowFilter += " ITEMNAME = '" + cmbItem4.Text + "'"
        End If
        If cmbSubItem4.Text.ToUpper <> "ALL" Then
            If Not RowFilter = Nothing Then
                RowFilter += " AND"
            End If
            RowFilter += " SUBITEMNAME = '" + cmbSubItem4.Text + "'"
        End If
        If cmbRange4.Text.ToUpper <> "ALL" Then
            If Not RowFilter = Nothing Then
                RowFilter += " AND"
            End If
            RowFilter += " RANGECAPTION = '" + cmbRange4.Text + "'"
        End If
        GridView4DaTa.DefaultView.RowFilter = RowFilter
        gridview.DataSource = GridView4DaTa.DefaultView

    End Sub

    Public Sub AddControlToGridView4(ByVal Image As Image, ByVal transparencyColor As Color, ByVal position As Point, ByVal dt As DataTable, ByVal flag As Boolean)
        ...
        Dim lblSubItem As New Label
        Dim lblRange As New Label
        ...
        With cmbItem4
            ...
            For Each row As DataRow In dt.Rows
                If Not .Items.Contains(row("ITEMNAME")) Then
        ...
        With cmbSubItem4
            ...
            .Items.Add("ALL")
            For Each row As DataRow In dt.Rows
                If Not .Items.Contains(row("SUBITEMNAME")) Then
                    .Items.Add(row("SUBITEMNAME"))
                End If
            Next
        ...
        With cmbRange4
            ...
            .Items.Add("ALL")
            For Each row As DataRow In dt.Rows
                If Not .Items.Contains(row("RANGECAPTION")) Then
                    .Items.Add(row("RANGECAPTION"))
                End If
            Next
        ...
        With panel1
            ...
            .Dock = DockStyle.Top
        End With
        panel1.Controls.Add(cmbItem4)
        panel1.Controls.Add(lblItem)
        panel1.Controls.Add(cmbSubItem4)
        panel1.Controls.Add(lblSubItem)
        panel1.Controls.Add(cmbRange4)
        ...
        For cnt As Integer = 0 To gridview.ColumnCount - 1
            ...
            If cnt > 1 Then
                gridview.Columns(cnt).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
                If gridview.Columns(cnt).Name = "ITEMNAME" Then
                    gridview.Columns(cnt).Width = 100
                    gridview.Columns(cnt).HeaderText = "ITEM"
                ElseIf gridview.Columns(cnt).Name = "SUBITEMNAME" Then
                    gridview.Columns(cnt).Width = 150
                    gridview.Columns(cnt).HeaderText = "SUBITEM"
                ElseIf gridview.Columns(cnt).Name = "RANGECAPTION" Then
                    gridview.Columns(cnt).Width = 60
                    gridview.Columns(cnt).HeaderText = "RANGE"
                ElseIf gridview.Columns(cnt).Name = "REORDERLEVEL" Then
                    gridview.Columns(cnt).Width = 80
                    gridview.Columns(cnt).HeaderText = "REQ-STOCK"
                ElseIf gridview.Columns(cnt).Name = "AVILABLE_PCS" Then
                    gridview.Columns(cnt).AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCells
                    gridview.Columns(cnt).HeaderText = "STOCK"
                ElseIf gridview.Columns(cnt).Name = "WANTED_PCS" Then
                    gridview.Columns(cnt).Width = 60
                    gridview.Columns(cnt).HeaderText = "WANTED"
                End If
            End If
        Next
    End Sub
    Public Sub AddControlToGridView5(ByVal Image As Image, ByVal transparencyColor As Color, ByVal position As Point, ByVal dt As DataTable, ByVal flag As Boolean)

        With gridview
            .Location = position
            .Size = New System.Drawing.Size(460, 225)
            .Name = "gridviewbirthremainder"
            .Font = New Font("Verdana", 8, FontStyle.Regular)
            .BackgroundColor = Color.White
            .ForeColor = Color.Black
            .AllowUserToAddRows = False
        ...
        Next
        If gridview.Columns.Contains("CustomerName") Then
            gridview.Columns("CustomerName").Width = 155
            gridview.Columns("CustomerName").HeaderText = "CustomerName"
        End If
        If gridview.Columns.Contains("WISHDATE") Then
            gridview.Columns("WISHDATE").Width = 100
            gridview.Columns("WISHDATE").HeaderText = "Wish Date"
        End If
        If gridview.Columns.Contains("WISHES") Then
            gridview.Columns("Wishes").Width = 100
            gridview.Columns("Wishes").HeaderText = "Wishes"
        End If
        If gridview.Columns.Contains("MOBILENO") Then
            gridview.Columns("MOBILENO").Width = 100
            gridview.Columns("MOBILENO").HeaderText = "MobileNo"
        End If
    End Sub
#End Region
