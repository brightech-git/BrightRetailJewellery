...
Public Class frmCustomerOutstanding
    ...
    Private Sub Report()
        ...
        Else
            FilterName = Replace(cmbFilterBy.Text, "'", "''''")
        End If
        strSql = "IF  EXISTS (SELECT * FROM MASTER..SYSOBJECTS WHERE XTYPE = 'U' AND NAME = 'TEMP_OUTSTANDING') DROP TABLE  MASTER..TEMP_OUTSTANDING"
...
EXESP:
        ...
        gridView.DataSource = dtGrid
        gridformat()
        GiritechPack.GlobalMethods.FormatGridColumns(gridView)
