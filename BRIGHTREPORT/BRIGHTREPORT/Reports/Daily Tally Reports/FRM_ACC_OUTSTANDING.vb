...
Public Class FRM_ACC_OUTSTANDING
    ...
    Private Sub FRM_ACC_OUTSTANDING_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        da = New OleDbDataAdapter(strSql, cn)
        da.Fill(dtAcGroup)
        GiritechPack.GlobalMethods.FillCombo(chkCmbAcGroup, dtAcGroup, "ACGRPNAME", , "ALL")
        btnNew_Click(Me, New EventArgs)
    End Sub
    ...
    Private Sub cmbAcName_Enter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbAcName.Enter
        ...
        da = New OleDbDataAdapter(strSql, cn)
        da.Fill(dtAcName)
        GiritechPack.GlobalMethods.FillCombo(cmbAcName, dtAcName, "ACNAME", True)
    End Sub
    ...
    Private Sub btnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        If chkCmbAcGroup.Text <> "ALL" And chkCmbAcGroup.Text <> "" Then
            ...
            strSql += vbCrLf + "(SELECT ACCODE FROM " & cnAdminDb & "..ACHEAD WHERE ACGRPCODE IN (SELECT ACGRPCODE FROM " & cnAdminDb & "..ACGROUP WHERE ACGRPNAME IN (" & GetQryString(chkCmbAcGroup.Text) & ")))"
        End If
