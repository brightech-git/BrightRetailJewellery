...
Public Class frmItemSalesPerformance
    ...
    Private Sub btnView_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnView_Search.Click
        Try
            ...
            strSql += ",@CASHCOUNTER='" & IIf(chkcmbCashCounter.Text.Trim <> "", GetQryString(chkcmbCashCounter.Text).Replace("'", ""), "ALL") & "'"
...
Public Class frmItemSalesPerformance_Properties
    ...
    Public Property p_cmbMetal() As String
        ...
        End Set
    End Property
    Private cmbcash As String = "ALL"
    Public Property p_cmbcash() As String
        Get
            Return cmbcash
        End Get
        Set(ByVal value As String)
