...
Public Class frmItemWiseProfit
    ...
    Private Sub btnSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        StrSql = "IF OBJECT_ID('" & cnStockDb & "..RASTMASTPURITY') IS NOT NULL DROP TABLE " & cnStockDb & "..RASTMASTPURITY"
        Cmd = New OleDbCommand(StrSql, cn) : Cmd.CommandTimeout = 1000
        Cmd.CommandTimeout = 1000
        Cmd.ExecuteNonQuery()

        StrSql = "SELECT MAX(SRATE) AS SRATE,RDATE,METALID "
        StrSql += "INTO " & cnStockDb & "..RASTMASTPURITY"
        StrSql += " FROM " & cnAdminDb & "..RATEMAST WHERE PURITY = '100' GROUP BY METALID,RDATE"
        Cmd = New OleDbCommand(StrSql, cn) : Cmd.CommandTimeout = 1000
        Cmd.CommandTimeout = 1000
        Cmd.ExecuteNonQuery()
        ...
        End If
        StrSql = " EXEC " & cnStockDb & "..PROC_RPT_ITEMWISEPROFIT"
    ...
    Private Sub DataGridView_SummaryFormatting(ByVal dgv As DataGridView)
        With dgv
            ...
            .Columns("GRSNET").Width = 60

            .Columns("PURITYRATE").Width = 100
            ...
            '.Columns("TAGVALUE").Visible = False
    ...
    Private Sub Prop_Gets()
        Dim obj As New frmItemWiseProfit_Properties
        GetSettingsObj(obj, Me.Name, GetType(frmItemWiseProfit_Properties))
    ...
    Private Sub Prop_Sets()
        ...
        SetSettingsObj(obj, Me.Name, GetType(frmItemWiseProfit_Properties))
    End Sub

End Class
Public Class frmItemWiseProfit_Properties
