        ...
        If rbtFifo.Checked Then
            ...
            If dtAdv.Rows.Count > 0 Then
                For M As Integer = 0 To dtAdv.Rows.Count - 1
                    ...
                    strSql += vbCrLf + "INNER JOIN " & cnAdminDb & "..ACHEAD AH ON AH.ACCODE=AC.ACCODE WHERE 1=1"
                    ...
                    If dt.Rows.Count > 0 Then
                        For N As Integer = 0 To dt.Rows.Count - 1
                            ...
                            strSql += vbCrLf + " ,'D'"
                            strSql += vbCrLf + " ,'DU'"
                            strSql += vbCrLf + " ," & IIf(dt.Rows(N).Item("TRANNO").ToString = "", 0, dt.Rows(N).Item("TRANNO").ToString) & ""
            ...
            da.Fill(dt)
        Else
            strSql = "SELECT * FROM " & cnAdminDb & "..OUTSTANDING WHERE 1=1 "
            If fromFlag <> "" Then strSql += vbCrLf + "AND FROMFLAG IN('P','S','A')"
            If cmbAcName_MAN.Text <> "" And cmbAcName_MAN.Text <> "ALL" Then
