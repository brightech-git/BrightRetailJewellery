...
Public Class rptNewSmithBalance
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BrighttechREPORT.rptNewSmithBalance.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptNewSmithBalance
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptNewSmithBalance = New rptNewSmithBalance()
        rpt.Site = Me.Site
        Return rpt
    End Function
