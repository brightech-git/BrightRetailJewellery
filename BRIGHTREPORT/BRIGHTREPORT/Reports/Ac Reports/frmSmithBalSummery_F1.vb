...
Imports System.IO
Public Class frmSmithBalSummery_F1
    ...
    Private Sub frmSmithBalSummery_F1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Function detprint()
        ...
        FileWrite.Close()
        line += 1
        Dim objprint As New frmPrinterSelect
        objprint.Show()
    End Function
