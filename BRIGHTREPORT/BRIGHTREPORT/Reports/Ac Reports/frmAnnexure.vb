...
Public Class frmAnnexure
    ...
    Private Sub btnView_Search_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnView_Search.Click
        ...
        strSql = vbCrLf + " SELECT C.TINNO,''CIB,IDENTITY(INT,1,1)SLNO,ACNAME,'G'GOVT,"
        strSql += vbCrLf + " PHONE,PANNO,DOBIRTH,''FATHERSNAME,DOORNO"
        strSql += vbCrLf + " ,AA.ADDRESS1,AA.ADDRESS2,AA.ADDRESS3,CITY,STATE"
        strSql += vbCrLf + " ,PINCODE,MODEPAY,AMOUNT,TRANDATE,TRANNO,REFNO,TRANDATE1"
        ...
        strSql = "SELECT * FROM TEMPTABLEDB.." & mtemptable & " ORDER BY TRANDATE1,TRANNO"
    ...
    Private Sub frmTrailBal_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        da = New OleDbDataAdapter(strSql, cn)
        da.Fill(dtacname)
        GiritechPack.GlobalMethods.FillCombo(chkcmbacname_OWN, dtacname, "ACNAME", , "ALL")
    ...
    Private Sub btnExcel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExport.Click
        ...
        If gridView.Rows.Count > 0 Then
            GiriPosting.GExport.Post(Me.Name, strCompanyName, lblTitle.Text, gridView, GiriPosting.GExport.GExportType.Export, Nothing)
        End If
    End Sub
    ...
    Private Sub btnPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        If gridView.Rows.Count > 0 Then
            GiriPosting.GExport.Post(Me.Name, strCompanyName, lblTitle.Text, gridView, GiriPosting.GExport.GExportType.Print, Nothing)
        End If
    End Sub
