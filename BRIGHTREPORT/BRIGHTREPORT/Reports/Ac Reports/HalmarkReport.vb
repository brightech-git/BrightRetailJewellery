...
Public Class HalmarkReport
    ...
    Private Function DetailView(ByVal CName As String) As DataTable
        Strsql = vbCrLf + " Exec " + cnStockDb + "..SP_RPT_HALMARKREPORT '" & strCompanyId & "', '" & Format(dtpFrom.Value, "yyyy-MM-dd") & "','" & Format(dtpTo.Value, "yyyy-MM-dd") & "'"
        Strsql += vbCrLf + ",'N'"
