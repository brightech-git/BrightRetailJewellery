...
Public Class frmTagStockView
    ...
    Private Sub frmTagStockView_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        If e.KeyCode = Keys.Enter Then
            SendKeys.Send("{TAB}")
        End If
    End Sub

    Private Sub frmTagStockView_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
    ...
    End Function
    Private Sub frmTagStockView_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        funcNew()
    End Sub
    Private Sub funcView()
        ...
        strSql = "EXEC " & cnAdminDb & "..PROC_ITEMSTOCKVIEW"
        ...
        If ds.Tables.Count > 0 Then
            ...
            End With
            lblReportTitle.Text = "TAGED ITEM STOCK VIEW"
