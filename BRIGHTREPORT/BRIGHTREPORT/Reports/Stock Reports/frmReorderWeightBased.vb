...
Imports System.IO
Public Class frmReorderWeightBased
    ...
    Private Sub HorizontalView()
        ...
        strSql = " EXECUTE " & cnAdminDb & "..SP_RPT_REORDERSTOCK_WEIGHTBASED"
    ...
    Private Sub GridViewHeaderStyle()
        ...
        If rbthorizontal.Checked Then
            ...
            Or gridview.Columns(i).HeaderText.Contains("REORDER") Or gridview.Columns(i).HeaderText.Contains("DIFF") _
            Then gridview.Columns(i).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
            Next
        ...
        Else
            ...
            gridheader1.Visible = False
            For i As Integer = 0 To gridview.Columns.Count - 1
                If gridview.Columns(i).HeaderText.Contains("PCS") Then gridview.Columns(i).HeaderText = "STOCK PCS"
                If gridview.Columns(i).HeaderText.Contains("GRSWT") Then gridview.Columns(i).HeaderText = "STOCK WT"
                If gridview.Columns(i).HeaderText.Contains("REORDERWT") Then
                    gridview.Columns(i).HeaderText = "REORDER WT"
                ElseIf gridview.Columns(i).HeaderText.Contains("REORDER") Then
                    gridview.Columns(i).HeaderText = "REORDER PCS"
                End If
                If gridview.Columns(i).HeaderText.Contains("DIFFWT") Then
                    gridview.Columns(i).HeaderText = "DIFF WT"
                ElseIf gridview.Columns(i).HeaderText.Contains("DIFF") Then
                    gridview.Columns(i).HeaderText = "DIFF PCS"
                End If
                If gridview.Columns(i).HeaderText.Contains("SALVALUE") Then gridview.Columns(i).HeaderText = "SALVALUE"
                If gridview.Columns(i).HeaderText.Contains("AMOUNT") Then gridview.Columns(i).HeaderText = "AMOUNT"
                If gridview.Columns(i).HeaderText.Contains("SALVALUE") Or gridview.Columns(i).HeaderText.Contains("STOCK PCS") _
            Or gridview.Columns(i).HeaderText.Contains("REORDER PCS") Or gridview.Columns(i).HeaderText.Contains("DIFF PCS") _
            Or gridview.Columns(i).HeaderText.Contains("STOCK WT") Or gridview.Columns(i).HeaderText.Contains("DIFF WT") _
            Or gridview.Columns(i).HeaderText.Contains("REORDER WT") _
            Then gridview.Columns(i).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
            Next
        ...
        For i As Integer = 0 To gridview.Rows.Count - 1
            ...
            End If
        Next
        If rbthorizontal.Checked Then gridview.Columns("PARTICULAR").HeaderText = "" Else gridview.Columns("PARTICULAR").HeaderText = "PARTICULAR"
    End Sub
    ...
    Private Sub btnExcel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExport.Click
        If gridview.Rows.Count > 0 Then
            ...
            rpttitle = "REORDER WEIGHT BASED STOCK"
