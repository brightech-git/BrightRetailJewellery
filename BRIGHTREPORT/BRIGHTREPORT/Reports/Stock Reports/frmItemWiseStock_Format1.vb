...
Imports System.Xml
Imports System.IO
Public Class frmItemWiseStock_Format1
    '01 SHERIFF - 24-10-12
    ...
    Private Sub GridStyle()
        ...
        With gridView
            ...
            .Columns("TRECPCS").Width = 70
            .Columns("TRECGRSWT").Width = 100
            .Columns("TRECNETWT").Width = 100
            If chkExtraWt.Checked Then .Columns("TRECEXTRAWT").Width = 100
            .Columns("TRECDIAPCS").Width = 70
            .Columns("TRECDIAWT").Width = 80
            .Columns("TRECSTNPCS").Width = 70
            .Columns("TRECSTNCRWT").Width = 80
            .Columns("TRECSTNGRWT").Width = 80
            .Columns("TRECVALUE").Width = 100
            .Columns("TRECDIAWT").DefaultCellStyle.Format = FormatNumberStyle(DiaRnd)
            ...
            .Columns("TISSPCS").Width = 70
            .Columns("TISSGRSWT").Width = 100
            .Columns("TISSNETWT").Width = 100
            If chkExtraWt.Checked Then .Columns("TISSEXTRAWT").Width = 100
            .Columns("TISSDIAPCS").Width = 70
            .Columns("TISSDIAWT").Width = 80
            .Columns("TISSSTNPCS").Width = 70
            .Columns("TISSSTNCRWT").Width = 80
            .Columns("TISSSTNGRWT").Width = 80
            .Columns("TISSVALUE").Width = 100
            .Columns("TISSDIAWT").DefaultCellStyle.Format = FormatNumberStyle(DiaRnd)
            ...
            If Not chkOnlyTag.Checked Then .Columns("TRECPCS").HeaderText = "PCS" Else .Columns("TRECPCS").HeaderText = "TAG"
            .Columns("TRECGRSWT").HeaderText = "GRSWT"
            .Columns("TRECNETWT").HeaderText = "NETWT"
            If chkExtraWt.Checked Then .Columns("TRECEXTRAWT").HeaderText = "EXTRAWT"
            .Columns("TRECDIAPCS").HeaderText = "DIAPCS"
            .Columns("TRECDIAWT").HeaderText = "DIAWT"
            .Columns("TRECSTNPCS").HeaderText = "STNPCS"
            .Columns("TRECSTNCRWT").HeaderText = "CARAT"
            .Columns("TRECSTNGRWT").HeaderText = "GRAM"
            .Columns("TRECVALUE").HeaderText = "VALUE"
            .Columns("TRECSALVALUE").HeaderText = "SALVALUE"
            ...
            If Not chkOnlyTag.Checked Then .Columns("TISSPCS").HeaderText = "PCS" Else .Columns("TISSPCS").HeaderText = "TAG"
            .Columns("TISSGRSWT").HeaderText = "GRSWT"
            .Columns("TISSNETWT").HeaderText = "NETWT"
            If chkExtraWt.Checked Then .Columns("TISSEXTRAWT").HeaderText = "EXTRAWT"
            .Columns("TISSDIAPCS").HeaderText = "DIAPCS"
            .Columns("TISSDIAWT").HeaderText = "DIAWT"
            .Columns("TISSSTNPCS").HeaderText = "STNPCS"
            .Columns("TISSSTNCRWT").HeaderText = "CARAT"
            .Columns("TISSSTNGRWT").HeaderText = "GRAM"
            .Columns("TISSVALUE").HeaderText = "VALUE"
            .Columns("TISSSALVALUE").HeaderText = "SALVALUE"
            ...
            .Columns("TRECGRSWT").Visible = chkGrsWt.Checked
            .Columns("TISSGRSWT").Visible = chkGrsWt.Checked
            If chkSeperateColumnApproval.Checked Then
            ...
            .Columns("TRECDIAPCS").Visible = rbtDiaStnByColumn.Checked And chkDiamond.Checked
            .Columns("TISSDIAPCS").Visible = rbtDiaStnByColumn.Checked And chkDiamond.Checked
            If chkSeperateColumnApproval.Checked Then
            ...
            .Columns("TRECDIAWT").Visible = rbtDiaStnByColumn.Checked And chkDiamond.Checked
            .Columns("TISSDIAWT").Visible = rbtDiaStnByColumn.Checked And chkDiamond.Checked
            If chkSeperateColumnApproval.Checked Then
            ...
            .Columns("TRECSTNPCS").Visible = rbtDiaStnByColumn.Checked And chkStone.Checked
            .Columns("TISSSTNPCS").Visible = rbtDiaStnByColumn.Checked And chkStone.Checked
            If chkSeperateColumnApproval.Checked Then
            ...
            .Columns("TRECSTNGRWT").Visible = rbtDiaStnByColumn.Checked And chkStone.Checked
            .Columns("TISSSTNGRWT").Visible = rbtDiaStnByColumn.Checked And chkStone.Checked
            If chkSeperateColumnApproval.Checked Then
            ...
            .Columns("TRECVALUE").Visible = chkStoneVal.Checked
            .Columns("TISSVALUE").Visible = chkStoneVal.Checked
            ...
            .Columns("TRECSALVALUE").Visible = chkWithValue.Checked
            .Columns("TISSSALVALUE").Visible = chkWithValue.Checked
            If chkSeperateColumnApproval.Checked Then
    ...
    Private Sub GridStyle1()
        ...
        With gridView
            If ChkTagWt.Checked = False And ChkCoverWt.Checked = False Then
                ...
                If .Columns.Contains("TRECTOTWT") Then .Columns("TRECTOTWT").Visible = False
                If .Columns.Contains("ITOTWT") Then .Columns("ITOTWT").Visible = False
                If .Columns.Contains("TISSTOTWT") Then .Columns("TISSTOTWT").Visible = False
                ...
                If .Columns.Contains("TRECBOXWT") Then .Columns("TRECBOXWT").Visible = False
            ...
            If ChkWithTag.Checked Then .Columns("TRECTAGS").Width = 70
            If ChkWithTag.Checked = False Then .Columns("TRECTAGS").Visible = False
            .Columns("TRECPCS").Width = 120
            .Columns("TRECGRSWT").Width = 100
            .Columns("TRECNETWT").Width = 100
            If chkExtraWt.Checked Then .Columns("TRECEXTRAWT").Width = 100
            .Columns("TRECDIAPCS").Width = 70
            ...
            If ChkWithTag.Checked Then .Columns("TISSTAGS").Width = 70
            If ChkWithTag.Checked = False Then .Columns("TISSTAGS").Visible = False
            .Columns("TISSPCS").Width = 70
            .Columns("TISSGRSWT").Width = 100
            .Columns("TISSNETWT").Width = 100
            If chkExtraWt.Checked Then .Columns("TISSEXTRAWT").Width = 100
            ...
            If .Columns.Contains("TRECTOTWT") Then .Columns("TRECTOTWT").HeaderText = "TOTALWT"
            If .Columns.Contains("ITOTWT") Then .Columns("ITOTWT").HeaderText = "TOTALWT"
            If .Columns.Contains("TISSTOTWT") Then .Columns("TISSTOTWT").HeaderText = "TOTALWT"
            ...
            If Not chkOnlyTag.Checked Then .Columns("TRECPCS").HeaderText = "TRAN-PCS" Else .Columns("TRECPCS").HeaderText = "TRAN-TAG"
            If ChkWithTag.Checked Then .Columns("TRECTAGS").HeaderText = "TRAN-NO.TAG"
            .Columns("TRECGRSWT").HeaderText = "TRAN-GRSWT"
            .Columns("TRECNETWT").HeaderText = "TRAN-NETWT"
            If chkExtraWt.Checked Then .Columns("TRECEXTRAWT").HeaderText = "TRAN-EXTRAWT"
            If ChkTagWt.Checked Then .Columns("TRECTAGWT").HeaderText = "TRAN-TAGWT"
            If ChkCoverWt.Checked Then .Columns("TRECCOVERWT").HeaderText = "TRAN-COVERWT"
            .Columns("TRECDIAPCS").HeaderText = "TRAN-DIAPCS"
            .Columns("TRECDIAWT").HeaderText = "TRAN-DIAWT"
            .Columns("TRECSTNPCS").HeaderText = "TRAN-STNPCS"
            .Columns("TRECSTNCRWT").HeaderText = "TRAN-CARAT"
            .Columns("TRECSTNGRWT").HeaderText = "TRAN-GRAM"
            .Columns("TRECVALUE").HeaderText = "TRAN-VALUE"
            .Columns("TRECSALVALUE").HeaderText = "TRAN-SALVALUE"
            ...
            If Not chkOnlyTag.Checked Then .Columns("TISSPCS").HeaderText = "TRAN-PCS" Else .Columns("TISSPCS").HeaderText = "TRAN-TAG"
            If ChkWithTag.Checked Then .Columns("TISSTAGS").HeaderText = "TRAN-NO.TAG"
            .Columns("TISSGRSWT").HeaderText = "TRAN-GRSWT"
            .Columns("TISSNETWT").HeaderText = "TRAN-NETWT"
            If chkExtraWt.Checked Then .Columns("TISSEXTRAWT").HeaderText = "TRAN-EXTRAWT"
            If ChkTagWt.Checked Then .Columns("TISSTAGWT").HeaderText = "TRAN-TAGWT"
            If ChkCoverWt.Checked Then .Columns("TISSCOVERWT").HeaderText = "TRAN-COVERWT"
            .Columns("TISSDIAPCS").HeaderText = "TRAN-DIAPCS"
            .Columns("TISSDIAWT").HeaderText = "TRAN-DIAWT"
            .Columns("TISSSTNPCS").HeaderText = "TRAN-STNPCS"
            .Columns("TISSSTNCRWT").HeaderText = "TRAN-CARAT"
            .Columns("TISSSTNGRWT").HeaderText = "TRAN-GRAM"
            .Columns("TISSVALUE").HeaderText = "TRAN-VALUE"
            .Columns("TISSSALVALUE").HeaderText = "TRAN-SALVALUE"
            ...
            If ChkWithTag.Checked Then .Columns("TISSTAGS").DefaultCellStyle.BackColor = Color.AliceBlue
            .Columns("TISSPCS").DefaultCellStyle.BackColor = Color.AliceBlue
            .Columns("TISSGRSWT").DefaultCellStyle.BackColor = Color.AliceBlue
            .Columns("TISSNETWT").DefaultCellStyle.BackColor = Color.AliceBlue
            If chkExtraWt.Checked Then .Columns("TISSEXTRAWT").DefaultCellStyle.BackColor = Color.AliceBlue
            .Columns("TISSDIAPCS").DefaultCellStyle.BackColor = Color.AliceBlue
            .Columns("TISSDIAWT").DefaultCellStyle.BackColor = Color.AliceBlue
            .Columns("TISSSTNPCS").DefaultCellStyle.BackColor = Color.AliceBlue
            .Columns("TISSSTNCRWT").DefaultCellStyle.BackColor = Color.AliceBlue
            .Columns("TISSSTNGRWT").DefaultCellStyle.BackColor = Color.AliceBlue
            .Columns("TISSVALUE").DefaultCellStyle.BackColor = Color.AliceBlue
            .Columns("TISSSALVALUE").DefaultCellStyle.BackColor = Color.AliceBlue
            ...
            .Columns("RSTNCRWT").Visible = rbtDiaStnByColumn.Checked And chkStone.Checked
            .Columns("RSTNGRWT").Visible = rbtDiaStnByColumn.Checked And chkStone.Checked
            .Columns("TRECSTNCRWT").Visible = rbtDiaStnByColumn.Checked And chkStone.Checked
            .Columns("TRECSTNGRWT").Visible = rbtDiaStnByColumn.Checked And chkStone.Checked
            .Columns("ISTNCRWT").Visible = rbtDiaStnByColumn.Checked And chkStone.Checked
            .Columns("ISTNGRWT").Visible = rbtDiaStnByColumn.Checked And chkStone.Checked
            .Columns("TISSSTNCRWT").Visible = rbtDiaStnByColumn.Checked And chkStone.Checked
            .Columns("TISSSTNGRWT").Visible = rbtDiaStnByColumn.Checked And chkStone.Checked
            If chkSeperateColumnApproval.Checked Then
            ...
            .Columns("ONETWT").Visible = chkNetWt.Checked
            .Columns("RNETWT").Visible = chkNetWt.Checked
            .Columns("TRECNETWT").Visible = chkNetWt.Checked
            .Columns("INETWT").Visible = chkNetWt.Checked
            .Columns("TISSNETWT").Visible = chkNetWt.Checked
            'If chkSeperateColumnApproval.Checked Then
    ...
    Private Sub SpReport()
        ...
        If chkBoffStockOnly.Checked Then
            ...
            If ChkWithTag.Checked Then dtx.Columns.Add("TRECTAGS")
            dtx.Columns.Add("TRECPCS")
            dtx.Columns.Add("TRECGRSWT")
            dtx.Columns.Add("TRECNETWT")
            If chkExtraWt.Checked Then dtx.Columns.Add("TRECEXTRAWT")
            dtx.Columns.Add("TRECDIAPCS")
            dtx.Columns.Add("TRECDIAWT")
            dtx.Columns.Add("TRECSTNPCS")
            ''
            dtx.Columns.Add("TRECSTNCRWT")
            dtx.Columns.Add("TRECSTNGRWT")
            dtx.Columns.Add("TRECVALUE")
            dtx.Columns.Add("TRECSALVALUE")
            ...
            If ChkWithTag.Checked Then dtx.Columns.Add("TISSTAGS")
            dtx.Columns.Add("TISSPCS")
            dtx.Columns.Add("TISSGRSWT")
            dtx.Columns.Add("TISSNETWT")
            If chkExtraWt.Checked Then dtx.Columns.Add("TISSEXTRAWT")
            dtx.Columns.Add("TISSDIAPCS")
            dtx.Columns.Add("TISSDIAWT")
            dtx.Columns.Add("TISSSTNPCS")
            ''
            dtx.Columns.Add("TISSSTNCRWT")
            dtx.Columns.Add("TISSSTNGRWT")
            dtx.Columns.Add("TISSVALUE")
            dtx.Columns.Add("TISSSALVALUE")
            If chkSeperateColumnApproval.Checked Then
        ...
        strSql = " EXEC " & cnAdminDb & "..RPT_ITEMWISESTOCK_FORMAT1"
        ...
        End If
        If rbtDiaStnByRow.Checked And (chkDiamond.Checked Or chkStone.Checked) Then
        ...
        If ChkLstGroupBy.CheckedItems.Contains("COUNTERGROUP") Then
            groupby = groupby + ",CG"
        End If
        If Not ChkLstGroupBy.CheckedItems.Contains("COUNTER") And Not ChkLstGroupBy.CheckedItems.Contains("DESIGNER") And Not ChkLstGroupBy.CheckedItems.Contains("COSTCENTRE") And Not ChkLstGroupBy.CheckedItems.Contains("ITEMTYPE") And Not ChkLstGroupBy.CheckedItems.Contains("COUNTERGROUP") Then
            groupby = ",N"
        End If
        ...
        ObjGrouper.pColumns_Sum.Add("TRECTAGS")
        ObjGrouper.pColumns_Sum.Add("TRECPCS")
        ObjGrouper.pColumns_Sum.Add("TRECGRSWT")
        ObjGrouper.pColumns_Sum.Add("TRECNETWT")
        If chkExtraWt.Checked Then ObjGrouper.pColumns_Sum.Add("TRECEXTRAWT")
        If ChkTagWt.Checked Then ObjGrouper.pColumns_Sum.Add("TRECTAGWT")
        If ChkCoverWt.Checked Then ObjGrouper.pColumns_Sum.Add("TRECCOVERWT")
        If chkSummary.Checked And (ChkCoverWt.Checked Or ChkTagWt.Checked) Then
            If Mid(groupby, 2, Len(groupby)) = "CU" Then
                ObjGrouper.pColumns_Sum.Add("TRECBOXWT")
                ObjGrouper.pColumns_Sum.Add("TRECTOTWT")
            End If
        End If
        ObjGrouper.pColumns_Sum.Add("TRECDIAPCS")
        ObjGrouper.pColumns_Sum.Add("TRECDIAWT")
        ObjGrouper.pColumns_Sum.Add("TRECSTNPCS")
        ''
        ObjGrouper.pColumns_Sum.Add("TRECSTNCRWT")
        ObjGrouper.pColumns_Sum.Add("TRECSTNGRWT")
        ObjGrouper.pColumns_Sum.Add("TRECVALUE")
        ObjGrouper.pColumns_Sum.Add("TRECSALVALUE")
        If chkSeperateColumnApproval.Checked Or chkOnlyApproval.Checked Then
        ...
        ObjGrouper.pColumns_Sum.Add("TISSTAGS")
        ObjGrouper.pColumns_Sum.Add("TISSPCS")
        ObjGrouper.pColumns_Sum.Add("TISSGRSWT")
        ObjGrouper.pColumns_Sum.Add("TISSNETWT")
        If chkExtraWt.Checked Then ObjGrouper.pColumns_Sum.Add("TISSEXTRAWT")
        If ChkTagWt.Checked Then ObjGrouper.pColumns_Sum.Add("TISSTAGWT")
        If ChkCoverWt.Checked Then ObjGrouper.pColumns_Sum.Add("TISSCOVERWT")
        If chkSummary.Checked And (ChkCoverWt.Checked Or ChkTagWt.Checked) Then
            If Mid(groupby, 2, Len(groupby)) = "CU" Then
                ObjGrouper.pColumns_Sum.Add("TISSBOXWT")
                ObjGrouper.pColumns_Sum.Add("TISSTOTWT")
            End If
        End If
        ObjGrouper.pColumns_Sum.Add("TISSDIAPCS")
        ObjGrouper.pColumns_Sum.Add("TISSDIAWT")
        ObjGrouper.pColumns_Sum.Add("TISSSTNPCS")
        ''
        ObjGrouper.pColumns_Sum.Add("TISSSTNCRWT")
        ObjGrouper.pColumns_Sum.Add("TISSSTNGRWT")
        ObjGrouper.pColumns_Sum.Add("TISSVALUE")
        ObjGrouper.pColumns_Sum.Add("TISSSALVALUE")
        If chkSeperateColumnApproval.Checked Or chkOnlyApproval.Checked Then
        ...
        If ChkWithTag.Checked Then strSql += vbCrLf + " ,SUM(TRECTAGS) TRECTAGS"
        strSql += vbCrLf + " ,SUM(TRECPCS) TRECPCS,SUM(TRECGRSWT) TRECGRSWT,SUM(TRECNETWT) TRECNETWT"
        If chkExtraWt.Checked Then strSql += vbCrLf + " ,SUM(TRECEXTRAWT)TRECEXTRAWT"
        If ChkTagWt.Checked Then strSql += vbCrLf + " ,SUM(TRECTAGWT)TRECTAGWT"
        If ChkCoverWt.Checked Then strSql += vbCrLf + " ,SUM(TRECCOVERWT)TRECCOVERWT"
        strSql += vbCrLf + " ,SUM(TRECDIAPCS) TRECDIAPCS,SUM(TRECDIAWT) TRECDIAWT,SUM(TRECSTNPCS) TRECSTNPCS,SUM(TRECSTNCRWT) TRECSTNCRWT,SUM(TRECSTNGRWT) TRECSTNGRWT,SUM(TRECVALUE) TRECVALUE,SUM(TRECSALVALUE) TRECSALVALUE"
        ...
        If ChkWithTag.Checked Then strSql += vbCrLf + " ,SUM(TISSTAGS) TISSTAGS"
        strSql += vbCrLf + " ,SUM(TISSPCS) TISSPCS,SUM(TISSGRSWT) TISSGRSWT,SUM(TISSNETWT) TISSNETWT"
        If chkExtraWt.Checked Then strSql += vbCrLf + " ,SUM(TISSEXTRAWT)TISSEXTRAWT"
        If ChkTagWt.Checked Then strSql += vbCrLf + " ,SUM(TISSTAGWT)TISSTAGWT"
        If ChkCoverWt.Checked Then strSql += vbCrLf + " ,SUM(TISSCOVERWT)TISSCOVERWT"
        strSql += vbCrLf + " ,SUM(TISSDIAPCS) TISSDIAPCS,SUM(TISSDIAWT) TISSDIAWT,SUM(TISSSTNPCS) TISSSTNPCS,SUM(TISSSTNCRWT) TISSSTNCRWT,SUM(TISSSTNGRWT) TISSSTNGRWT,SUM(TISSVALUE) TISSVALUE,SUM(TISSSALVALUE) TISSSALVALUE"
        ...
        End If
        strSql += vbCrLf + "  FROM TEMPTABLEDB..TEMP" & SYSTEMID & "ITEMSTK WHERE STONE=1"
        ...
        If DTSTUD.Rows.Count > 0 Then
            For cnt As Integer = 0 To DTSTUD.Rows.Count - 1
                ...
                With DTSTUD.Rows(cnt)
                    ...
                    If ChkWithTag.Checked Then gridView.Rows(gridView.RowCount - 1).Cells("TRECTAGS").Value = .Item("TRECTAGS")
                    gridView.Rows(gridView.RowCount - 1).Cells("TRECPCS").Value = .Item("TRECPCS")
                    gridView.Rows(gridView.RowCount - 1).Cells("TRECGRSWT").Value = .Item("TRECGRSWT")
                    gridView.Rows(gridView.RowCount - 1).Cells("TRECNETWT").Value = .Item("TRECNETWT")
                    If chkExtraWt.Checked Then gridView.Rows(gridView.RowCount - 1).Cells("TRECEXTRAWT").Value = .Item("TRECEXTRAWT")
                    If ChkTagWt.Checked Then gridView.Rows(gridView.RowCount - 1).Cells("TRECTAGWT").Value = .Item("TRECTAGWT")
                    If ChkCoverWt.Checked Then gridView.Rows(gridView.RowCount - 1).Cells("TRECCOVERWT").Value = .Item("TRECCOVERWT")
                    gridView.Rows(gridView.RowCount - 1).Cells("TRECDIAPCS").Value = .Item("TRECDIAPCS")
                    gridView.Rows(gridView.RowCount - 1).Cells("TRECDIAWT").Value = .Item("TRECDIAWT")
                    gridView.Rows(gridView.RowCount - 1).Cells("TRECSTNPCS").Value = .Item("TRECSTNPCS")
                    ''
                    gridView.Rows(gridView.RowCount - 1).Cells("TRECSTNCRWT").Value = .Item("TRECSTNCRWT")
                    gridView.Rows(gridView.RowCount - 1).Cells("TRECSTNGRWT").Value = .Item("TRECSTNGRWT")
                    gridView.Rows(gridView.RowCount - 1).Cells("TRECVALUE").Value = .Item("TRECVALUE")
                    gridView.Rows(gridView.RowCount - 1).Cells("TRECSALVALUE").Value = .Item("TRECSALVALUE")
                    ...
                    If ChkWithTag.Checked Then gridView.Rows(gridView.RowCount - 1).Cells("TISSTAGS").Value = .Item("TISSTAGS")
                    gridView.Rows(gridView.RowCount - 1).Cells("TISSPCS").Value = .Item("TISSPCS")
                    gridView.Rows(gridView.RowCount - 1).Cells("TISSGRSWT").Value = .Item("TISSGRSWT")
                    gridView.Rows(gridView.RowCount - 1).Cells("TISSNETWT").Value = .Item("TISSNETWT")
                    If chkExtraWt.Checked Then gridView.Rows(gridView.RowCount - 1).Cells("TISSEXTRAWT").Value = .Item("TISSEXTRAWT")
                    If ChkTagWt.Checked Then gridView.Rows(gridView.RowCount - 1).Cells("TISSTAGWT").Value = .Item("TISSTAGWT")
                    If ChkCoverWt.Checked Then gridView.Rows(gridView.RowCount - 1).Cells("TISSCOVERWT").Value = .Item("TISSCOVERWT")
                    gridView.Rows(gridView.RowCount - 1).Cells("TISSDIAPCS").Value = .Item("TISSDIAPCS")
                    gridView.Rows(gridView.RowCount - 1).Cells("TISSDIAWT").Value = .Item("TISSDIAWT")
                    gridView.Rows(gridView.RowCount - 1).Cells("TISSSTNPCS").Value = .Item("TISSSTNPCS")
                    ''
                    gridView.Rows(gridView.RowCount - 1).Cells("TISSSTNCRWT").Value = .Item("TISSSTNCRWT")
                    gridView.Rows(gridView.RowCount - 1).Cells("TISSSTNGRWT").Value = .Item("TISSSTNGRWT")
                    gridView.Rows(gridView.RowCount - 1).Cells("TISSVALUE").Value = .Item("TISSVALUE")
                    gridView.Rows(gridView.RowCount - 1).Cells("TISSSALVALUE").Value = .Item("TISSSALVALUE")
        ...
        If HideSummary = False Then
            ...
            CType(gridView.DataSource, DataTable).Rows.Add()
            gridView.Rows(gridView.RowCount - 1).Cells("PARTICULAR").Value = "TRANSFER RECEIPT"
            If ChkWithTag.Checked Then gridView.Rows(gridView.RowCount - 1).Cells("OTAGS").Value = gridView.Rows(ind).Cells("TRECTAGS").Value
            gridView.Rows(gridView.RowCount - 1).Cells("OPCS").Value = gridView.Rows(ind).Cells("TRECPCS").Value
            gridView.Rows(gridView.RowCount - 1).Cells("OGRSWT").Value = gridView.Rows(ind).Cells("TRECGRSWT").Value
            gridView.Rows(gridView.RowCount - 1).Cells("ONETWT").Value = gridView.Rows(ind).Cells("TRECNETWT").Value
            If chkExtraWt.Checked Then gridView.Rows(gridView.RowCount - 1).Cells("OEXTRAWT").Value = gridView.Rows(ind).Cells("TRECEXTRAWT").Value
            If ChkTagWt.Checked Then gridView.Rows(gridView.RowCount - 1).Cells("OTAGWT").Value = gridView.Rows(ind).Cells("TRECTAGWT").Value
            If ChkCoverWt.Checked Then gridView.Rows(gridView.RowCount - 1).Cells("OCOVERWT").Value = gridView.Rows(ind).Cells("TRECCOVERWT").Value
            gridView.Rows(gridView.RowCount - 1).Cells("ODIAPCS").Value = gridView.Rows(ind).Cells("TRECDIAPCS").Value
            gridView.Rows(gridView.RowCount - 1).Cells("ODIAWT").Value = gridView.Rows(ind).Cells("TRECDIAWT").Value
            gridView.Rows(gridView.RowCount - 1).Cells("OSTNPCS").Value = gridView.Rows(ind).Cells("TRECSTNPCS").Value

            gridView.Rows(gridView.RowCount - 1).Cells("OSTNCRWT").Value = gridView.Rows(ind).Cells("TRECSTNCRWT").Value
            gridView.Rows(gridView.RowCount - 1).Cells("OSTNGRWT").Value = gridView.Rows(ind).Cells("TRECSTNGRWT").Value
            gridView.Rows(gridView.RowCount - 1).Cells("OVALUE").Value = gridView.Rows(ind).Cells("TRECVALUE").Value
            gridView.Rows(gridView.RowCount - 1).Cells("OSALVALUE").Value = gridView.Rows(ind).Cells("TRECSALVALUE").Value
            gridView.Rows(gridView.RowCount - 1).Cells("COLHEAD").Value = "G"
            gridView.Rows(gridView.RowCount - 1).DefaultCellStyle = Globalvariables.reportTotalStyle
            ...
            CType(gridView.DataSource, DataTable).Rows.Add()
            gridView.Rows(gridView.RowCount - 1).Cells("PARTICULAR").Value = "TRANSFER ISSUE"
            If ChkWithTag.Checked Then gridView.Rows(gridView.RowCount - 1).Cells("OTAGS").Value = gridView.Rows(ind).Cells("TISSTAGS").Value
            gridView.Rows(gridView.RowCount - 1).Cells("OPCS").Value = gridView.Rows(ind).Cells("TISSPCS").Value
            gridView.Rows(gridView.RowCount - 1).Cells("OGRSWT").Value = gridView.Rows(ind).Cells("TISSGRSWT").Value
            gridView.Rows(gridView.RowCount - 1).Cells("ONETWT").Value = gridView.Rows(ind).Cells("TISSNETWT").Value
            If chkExtraWt.Checked Then gridView.Rows(gridView.RowCount - 1).Cells("OEXTRAWT").Value = gridView.Rows(ind).Cells("TISSEXTRAWT").Value
            If ChkTagWt.Checked Then gridView.Rows(gridView.RowCount - 1).Cells("OTAGWT").Value = gridView.Rows(ind).Cells("TISSTAGWT").Value
            If ChkCoverWt.Checked Then gridView.Rows(gridView.RowCount - 1).Cells("OCOVERWT").Value = gridView.Rows(ind).Cells("TISSCOVERWT").Value
            gridView.Rows(gridView.RowCount - 1).Cells("ODIAPCS").Value = gridView.Rows(ind).Cells("TISSDIAPCS").Value
            gridView.Rows(gridView.RowCount - 1).Cells("ODIAWT").Value = gridView.Rows(ind).Cells("TISSDIAWT").Value
            gridView.Rows(gridView.RowCount - 1).Cells("OSTNPCS").Value = gridView.Rows(ind).Cells("TISSSTNPCS").Value

            gridView.Rows(gridView.RowCount - 1).Cells("OSTNCRWT").Value = gridView.Rows(ind).Cells("TISSSTNCRWT").Value
            gridView.Rows(gridView.RowCount - 1).Cells("OSTNGRWT").Value = gridView.Rows(ind).Cells("TISSSTNGRWT").Value
            gridView.Rows(gridView.RowCount - 1).Cells("OVALUE").Value = gridView.Rows(ind).Cells("TISSVALUE").Value
            gridView.Rows(gridView.RowCount - 1).Cells("OSALVALUE").Value = gridView.Rows(ind).Cells("TISSSALVALUE").Value
            gridView.Rows(gridView.RowCount - 1).Cells("COLHEAD").Value = "G"
            gridView.Rows(gridView.RowCount - 1).DefaultCellStyle = Globalvariables.reportTotalStyle
...
bkoffstk:
        ...
        If chkSeperateColumnApproval.Checked Then
            ...
            If chkExtraWt.Checked = False Then If gridView.Columns.Contains("TRECEXTRAWT") Then gridView.Columns("TRECEXTRAWT").Visible = False
            If chkExtraWt.Checked = False Then If gridView.Columns.Contains("IEXTRAWT") Then gridView.Columns("IEXTRAWT").Visible = False
            If chkExtraWt.Checked = False Then If gridView.Columns.Contains("TISSEXTRAWT") Then gridView.Columns("TISSEXTRAWT").Visible = False
            ...
            If ChkTagWt.Checked = False Then If gridView.Columns.Contains("TRECTAGWT") Then gridView.Columns("TRECTAGWT").Visible = False
            If ChkTagWt.Checked = False Then If gridView.Columns.Contains("ITAGWT") Then gridView.Columns("ITAGWT").Visible = False
            If ChkTagWt.Checked = False Then If gridView.Columns.Contains("TISSTAGWT") Then gridView.Columns("TISSTAGWT").Visible = False
            ...
            If ChkCoverWt.Checked = False Then If gridView.Columns.Contains("TRECCOVERWT") Then gridView.Columns("TRECCOVERWT").Visible = False
            If ChkCoverWt.Checked = False Then If gridView.Columns.Contains("ICOVERWT") Then gridView.Columns("ICOVERWT").Visible = False
            If ChkCoverWt.Checked = False Then If gridView.Columns.Contains("TISSCOVERWT") Then gridView.Columns("TISSCOVERWT").Visible = False
        ...
        ElseIf chkOnlyApproval.Checked = True Then
            ...
            'TRANSFER RECEIPT
            If ChkWithTag.Checked = False Then gridView.Columns("TRECTAGS").Visible = False
            gridView.Columns("TRECPCS").Visible = False
            gridView.Columns("TRECGRSWT").Visible = False
            gridView.Columns("TRECNETWT").Visible = False
            If chkExtraWt.Checked = False Then gridView.Columns("TRECEXTRAWT").Visible = False
            If ChkTagWt.Checked = False And gridView.Columns.Contains("TRECTAGWT") Then gridView.Columns("TRECTAGWT").Visible = False
            If ChkCoverWt.Checked = False And gridView.Columns.Contains("TRECCOVERWT") Then gridView.Columns("TRECCOVERWT").Visible = False
            gridView.Columns("TRECDIAPCS").Visible = False
            gridView.Columns("TRECDIAWT").Visible = False
            gridView.Columns("TRECSTNPCS").Visible = False
            gridView.Columns("TRECSTNCRWT").Visible = False
            gridView.Columns("TRECSTNGRWT").Visible = False
            gridView.Columns("TRECVALUE").Visible = False
            gridView.Columns("TRECSALVALUE").Visible = False
            ...
            'TRANSFER ISSUE
            If ChkWithTag.Checked = False Then gridView.Columns("TISSTAGS").Visible = False
            gridView.Columns("TISSPCS").Visible = False
            gridView.Columns("TISSGRSWT").Visible = False
            gridView.Columns("TISSNETWT").Visible = False
            If chkExtraWt.Checked = False Then gridView.Columns("TISSEXTRAWT").Visible = False
            If ChkTagWt.Checked = False And gridView.Columns.Contains("TISSTAGWT") Then gridView.Columns("TISSTAGWT").Visible = False
            If ChkCoverWt.Checked = False And gridView.Columns.Contains("TISSCOVERWT") Then gridView.Columns("TISSCOVERWT").Visible = False
            gridView.Columns("TISSDIAPCS").Visible = False
            gridView.Columns("TISSDIAWT").Visible = False
            gridView.Columns("TISSSTNPCS").Visible = False
            gridView.Columns("TISSSTNCRWT").Visible = False
            gridView.Columns("TISSSTNGRWT").Visible = False
            gridView.Columns("TISSVALUE").Visible = False
            gridView.Columns("TISSSALVALUE").Visible = False
        ...
        Else
            ...
            If chkExtraWt.Checked = False And gridView.Columns.Contains("TRECEXTRAWT") Then gridView.Columns("TRECEXTRAWT").Visible = False
            If chkExtraWt.Checked = False And gridView.Columns.Contains("IEXTRAWT") Then gridView.Columns("IEXTRAWT").Visible = False
            If chkExtraWt.Checked = False And gridView.Columns.Contains("TISSEXTRAWT") Then gridView.Columns("TISSEXTRAWT").Visible = False
    ...
    Private Sub Report()
        ...
        Else
            If chkOrderbyItemId.Checked Then
                strSql += vbCrLf + "     ,(SELECT '['+REPLICATE(' ',4-LEN(X.ITEMID)) + CONVERT(VARCHAR,X.ITEMID) + '] ' + ITEMNAME FROM " & cnAdminDb & "..ITEMMAST WHERE ITEMID = X.ITEMID)AS ITEM"
            Else
                strSql += vbCrLf + " ,(SELECT ITEMNAME FROM " & cnAdminDb & "..ITEMMAST WHERE ITEMID = X.ITEMID)AS ITEM"
            End If
            If chkOrderbyItemId.Checked Then
                strSql += vbCrLf + "     ,(SELECT '['+REPLICATE(' ',4-LEN(X.TITEMID)) + CONVERT(VARCHAR,X.TITEMID) + '] ' + ITEMNAME FROM " & cnAdminDb & "..ITEMMAST WHERE ITEMID = X.TITEMID)AS TITEM"
            Else
                strSql += vbCrLf + " ,(SELECT ITEMNAME FROM " & cnAdminDb & "..ITEMMAST WHERE ITEMID = X.TITEMID)AS TITEM"
            End If
            If chkOrderbyItemId.Checked Then
                strSql += vbCrLf + "     ,(SELECT '['+REPLICATE(' ',4-LEN(X.SUBITEMID)) + CONVERT(VARCHAR,X.SUBITEMID) + ']' + SUBITEMNAME FROM " & cnAdminDb & "..SUBITEMMAST WHERE SUBITEMID = X.SUBITEMID)AS SUBITEM"
            Else
    ...
    Private Sub GridViewHeaderStyle1()
        ...
        If chkExtraWt.Checked Then strRExtraWt = "~REXTRAWT"
        If chkExtraWt.Checked Then strRExtraWt = "~TRECEXTRAWT"
        If chkExtraWt.Checked Then strIExtraWt = "~IEXTRAWT"
        If chkExtraWt.Checked Then strRExtraWt = "~TISSEXTRAWT"
        If chkExtraWt.Checked Then strARExtraWt = "~AREXTRAWT"
        If chkExtraWt.Checked Then strAIExtraWt = "~AIEXTRAWT"
        If chkExtraWt.Checked Then strCExtraWt = "~CEXTRAWT"
        ...
        If ChkTagWt.Checked Then strRTagWt = "~TRECTAGWT"
        If ChkTagWt.Checked Then strITagWt = "~ITAGWT"
        If ChkTagWt.Checked Then strRTagWt = "~TISSTAGWT"
        ...
        If ChkCoverWt.Checked Then strRCoverWt = "~TRECCOVERWT"
        If ChkCoverWt.Checked Then strICoverWt = "~ICOVERWT"
        If ChkCoverWt.Checked Then strRCoverWt = "~TISSCOVERWT"
        ...
        If chkSummary.Checked And (ChkCoverWt.Checked Or ChkTagWt.Checked) Then
            If Mid(grpby, 2, Len(grpby)) = "CU" Then
                ...
                strRCoverWt += "~TRECBOXWT~TRECTOTWT"
                strICoverWt += "~IBOXWT~ITOTWT"
                strICoverWt += "~TISSBOXWT~TISSTOTWT"
        ...
        With dtMergeHeader
            ...
            .Columns.Add("RTAGS~RPCS~RGRSWT~RNETWT~TRECTAGS~TRECPCS~TRECGRSWT~TRECNETWT" & strRExtraWt & strRTagWt & strRCoverWt & "~RDIAPCS~RDIAWT~RSTNPCS~RSTNCRWT~RSTNGRWT~RTAGPCS~RVALUE~RSALVALUE~TRECDIAPCS~TRECDIAWT~TRECSTNPCS~TRECSTNCRWT~TRECSTNGRWT~TRECTAGPCS~TRECVALUE~TRECSALVALUE" & strRAPPROVAL, GetType(String))
            .Columns.Add("ITAGS~IPCS~IGRSWT~INETWT~TISSTAGS~TISSPCS~TISSGRSWT~TISSNETWT" & strIExtraWt & strITagWt & strICoverWt & "~IDIAPCS~IDIAWT~ISTNPCS~ISTNCRWT~ISTNGRWT~ITAGPCS~IVALUE~ISALVALUE~TISSDIAPCS~TISSDIAWT~TISSSTNPCS~TISSSTNCRWT~TISSSTNGRWT~TISSTAGPCS~TISSVALUE~TISSSALVALUE" & strIAPPROVAL, GetType(String))
            ...
            .Columns("RTAGS~RPCS~RGRSWT~RNETWT~TRECTAGS~TRECPCS~TRECGRSWT~TRECNETWT" & strRExtraWt & strRTagWt & strRCoverWt & "~RDIAPCS~RDIAWT~RSTNPCS~RSTNCRWT~RSTNGRWT~RTAGPCS~RVALUE~RSALVALUE~TRECDIAPCS~TRECDIAWT~TRECSTNPCS~TRECSTNCRWT~TRECSTNGRWT~TRECTAGPCS~TRECVALUE~TRECSALVALUE" & strRAPPROVAL).Caption = "RECEIPT"
            .Columns("ITAGS~IPCS~IGRSWT~INETWT~TISSTAGS~TISSPCS~TISSGRSWT~TISSNETWT" & strIExtraWt & strITagWt & strICoverWt & "~IDIAPCS~IDIAWT~ISTNPCS~ISTNCRWT~ISTNGRWT~ITAGPCS~IVALUE~ISALVALUE~TISSDIAPCS~TISSDIAWT~TISSSTNPCS~TISSSTNCRWT~TISSSTNGRWT~TISSTAGPCS~TISSVALUE~TISSSALVALUE" & strIAPPROVAL).Caption = "ISSUE"
    ...
    Private Sub frmItemWiseStock_Format1_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
    ...
    Function funcColWidth1() As Integer
        With gridViewHead
            ...
            If chkSummary.Checked And (ChkCoverWt.Checked Or ChkTagWt.Checked) Then
                If Mid(grpby, 2, Len(grpby)) = "CU" Then
                    strOCoverWt += "~OBOXWT~OTOTWT"
                    strRCoverWt += "~RBOXWT~RTOTWT~TRECBOXWT"
                    strICoverWt += "~IBOXWT~ITOTWT~TISSBOXWT"
                    strCCoverWt += "~CBOXWT~CTOTWT"
                End If
            End If
            ...
            .Columns("RTAGS~RPCS~RGRSWT~RNETWT~TRECTAGS~TRECPCS~TRECGRSWT~TRECNETWT" & strRExtraWt & strRTagWt & strRCoverWt & "~RDIAPCS~RDIAWT~RSTNPCS~RSTNCRWT~RSTNGRWT~RTAGPCS~RVALUE~RSALVALUE~TRECDIAPCS~TRECDIAWT~TRECSTNPCS~TRECSTNCRWT~TRECSTNGRWT~TRECTAGPCS~TRECVALUE~TRECSALVALUE" & strRSepApp).Width = gridView.Columns("RPCS").Width
            .Columns("RTAGS~RPCS~RGRSWT~RNETWT~TRECTAGS~TRECPCS~TRECGRSWT~TRECNETWT" & strRExtraWt & strRTagWt & strRCoverWt & "~RDIAPCS~RDIAWT~RSTNPCS~RSTNCRWT~RSTNGRWT~RTAGPCS~RVALUE~RSALVALUE~TRECDIAPCS~TRECDIAWT~TRECSTNPCS~TRECSTNCRWT~TRECSTNGRWT~TRECTAGPCS~TRECVALUE~TRECSALVALUE" & strRSepApp).Width = gridView.Columns("TRECPCS").Width
            If ChkWithTag.Checked Then .Columns("RTAGS~RPCS~RGRSWT~RNETWT~TRECTAGS~TRECPCS~TRECGRSWT~TRECNETWT" & strRExtraWt & strRTagWt & strRCoverWt & "~RDIAPCS~RDIAWT~RSTNPCS~RSTNCRWT~RSTNGRWT~RTAGPCS~RVALUE~RSALVALUE~TRECDIAPCS~TRECDIAWT~TRECSTNPCS~TRECSTNCRWT~TRECSTNGRWT~TRECTAGPCS~TRECVALUE~TRECSALVALUE" & strRSepApp).Width += gridView.Columns("RTAGS").Width
            If ChkWithTag.Checked Then .Columns("RTAGS~RPCS~RGRSWT~RNETWT~TRECTAGS~TRECPCS~TRECGRSWT~TRECNETWT" & strRExtraWt & strRTagWt & strRCoverWt & "~RDIAPCS~RDIAWT~RSTNPCS~RSTNCRWT~RSTNGRWT~RTAGPCS~RVALUE~RSALVALUE~TRECDIAPCS~TRECDIAWT~TRECSTNPCS~TRECSTNCRWT~TRECSTNGRWT~TRECTAGPCS~TRECVALUE~TRECSALVALUE" & strRSepApp).Width += gridView.Columns("TRECTAGS").Width
            If chkGrsWt.Checked Then .Columns("RTAGS~RPCS~RGRSWT~RNETWT~TRECTAGS~TRECPCS~TRECGRSWT~TRECNETWT" & strRExtraWt & strRTagWt & strRCoverWt & "~RDIAPCS~RDIAWT~RSTNPCS~RSTNCRWT~RSTNGRWT~RTAGPCS~RVALUE~RSALVALUE~TRECDIAPCS~TRECDIAWT~TRECSTNPCS~TRECSTNCRWT~TRECSTNGRWT~TRECTAGPCS~TRECVALUE~TRECSALVALUE" & strRSepApp).Width += gridView.Columns("RGRSWT").Width
            If chkGrsWt.Checked Then .Columns("RTAGS~RPCS~RGRSWT~RNETWT~TRECTAGS~TRECPCS~TRECGRSWT~TRECNETWT" & strRExtraWt & strRTagWt & strRCoverWt & "~RDIAPCS~RDIAWT~RSTNPCS~RSTNCRWT~RSTNGRWT~RTAGPCS~RVALUE~RSALVALUE~TRECDIAPCS~TRECDIAWT~TRECSTNPCS~TRECSTNCRWT~TRECSTNGRWT~TRECTAGPCS~TRECVALUE~TRECSALVALUE" & strRSepApp).Width += gridView.Columns("TRECGRSWT").Width
            If chkNetWt.Checked Then .Columns("RTAGS~RPCS~RGRSWT~RNETWT~TRECTAGS~TRECPCS~TRECGRSWT~TRECNETWT" & strRExtraWt & strRTagWt & strRCoverWt & "~RDIAPCS~RDIAWT~RSTNPCS~RSTNCRWT~RSTNGRWT~RTAGPCS~RVALUE~RSALVALUE~TRECDIAPCS~TRECDIAWT~TRECSTNPCS~TRECSTNCRWT~TRECSTNGRWT~TRECTAGPCS~TRECVALUE~TRECSALVALUE" & strRSepApp).Width += gridView.Columns("RNETWT").Width
            If chkNetWt.Checked Then .Columns("RTAGS~RPCS~RGRSWT~RNETWT~TRECTAGS~TRECPCS~TRECGRSWT~TRECNETWT" & strRExtraWt & strRTagWt & strRCoverWt & "~RDIAPCS~RDIAWT~RSTNPCS~RSTNCRWT~RSTNGRWT~RTAGPCS~RVALUE~RSALVALUE~TRECDIAPCS~TRECDIAWT~TRECSTNPCS~TRECSTNCRWT~TRECSTNGRWT~TRECTAGPCS~TRECVALUE~TRECSALVALUE" & strRSepApp).Width += gridView.Columns("TRECNETWT").Width
            If chkExtraWt.Checked Then .Columns("RTAGS~RPCS~RGRSWT~RNETWT~TRECTAGS~TRECPCS~TRECGRSWT~TRECNETWT" & strRExtraWt & strRTagWt & strRCoverWt & "~RDIAPCS~RDIAWT~RSTNPCS~RSTNCRWT~RSTNGRWT~RTAGPCS~RVALUE~RSALVALUE~TRECDIAPCS~TRECDIAWT~TRECSTNPCS~TRECSTNCRWT~TRECSTNGRWT~TRECTAGPCS~TRECVALUE~TRECSALVALUE" & strRSepApp).Width += gridView.Columns("REXTRAWT").Width
            If chkExtraWt.Checked Then .Columns("RTAGS~RPCS~RGRSWT~RNETWT~TRECTAGS~TRECPCS~TRECGRSWT~TRECNETWT" & strRExtraWt & strRTagWt & strRCoverWt & "~RDIAPCS~RDIAWT~RSTNPCS~RSTNCRWT~RSTNGRWT~RTAGPCS~RVALUE~RSALVALUE~TRECDIAPCS~TRECDIAWT~TRECSTNPCS~TRECSTNCRWT~TRECSTNGRWT~TRECTAGPCS~TRECVALUE~TRECSALVALUE" & strRSepApp).Width += gridView.Columns("TRECEXTRAWT").Width
            If ChkTagWt.Checked Then .Columns("RTAGS~RPCS~RGRSWT~RNETWT~TRECTAGS~TRECPCS~TRECGRSWT~TRECNETWT" & strRExtraWt & strRTagWt & strRCoverWt & "~RDIAPCS~RDIAWT~RSTNPCS~RSTNCRWT~RSTNGRWT~RTAGPCS~RVALUE~RSALVALUE~TRECDIAPCS~TRECDIAWT~TRECSTNPCS~TRECSTNCRWT~TRECSTNGRWT~TRECTAGPCS~TRECVALUE~TRECSALVALUE" & strRSepApp).Width += gridView.Columns("RTAGWT").Width
            If ChkTagWt.Checked Then .Columns("RTAGS~RPCS~RGRSWT~RNETWT~TRECTAGS~TRECPCS~TRECGRSWT~TRECNETWT" & strRExtraWt & strRTagWt & strRCoverWt & "~RDIAPCS~RDIAWT~RSTNPCS~RSTNCRWT~RSTNGRWT~RTAGPCS~RVALUE~RSALVALUE~TRECDIAPCS~TRECDIAWT~TRECSTNPCS~TRECSTNCRWT~TRECSTNGRWT~TRECTAGPCS~TRECVALUE~TRECSALVALUE" & strRSepApp).Width += gridView.Columns("TRECTAGWT").Width
            If ChkCoverWt.Checked Then .Columns("RTAGS~RPCS~RGRSWT~RNETWT~TRECTAGS~TRECPCS~TRECGRSWT~TRECNETWT" & strRExtraWt & strRTagWt & strRCoverWt & "~RDIAPCS~RDIAWT~RSTNPCS~RSTNCRWT~RSTNGRWT~RTAGPCS~RVALUE~RSALVALUE~TRECDIAPCS~TRECDIAWT~TRECSTNPCS~TRECSTNCRWT~TRECSTNGRWT~TRECTAGPCS~TRECVALUE~TRECSALVALUE" & strRSepApp).Width += gridView.Columns("RCOVERWT").Width
            If ChkCoverWt.Checked Then .Columns("RTAGS~RPCS~RGRSWT~RNETWT~TRECTAGS~TRECPCS~TRECGRSWT~TRECNETWT" & strRExtraWt & strRTagWt & strRCoverWt & "~RDIAPCS~RDIAWT~RSTNPCS~RSTNCRWT~RSTNGRWT~RTAGPCS~RVALUE~RSALVALUE~TRECDIAPCS~TRECDIAWT~TRECSTNPCS~TRECSTNCRWT~TRECSTNGRWT~TRECTAGPCS~TRECVALUE~TRECSALVALUE" & strRSepApp).Width += gridView.Columns("TRECCOVERWT").Width
            If chkSummary.Checked And (ChkCoverWt.Checked Or ChkTagWt.Checked) Then
                If Mid(grpby, 2, Len(grpby)) = "CU" Then
                    .Columns("RTAGS~RPCS~RGRSWT~RNETWT~TRECTAGS~TRECPCS~TRECGRSWT~TRECNETWT" & strRExtraWt & strRTagWt & strRCoverWt & "~RDIAPCS~RDIAWT~RSTNPCS~RSTNCRWT~RSTNGRWT~RTAGPCS~RVALUE~RSALVALUE~TRECDIAPCS~TRECDIAWT~TRECSTNPCS~TRECSTNCRWT~TRECSTNGRWT~TRECTAGPCS~TRECVALUE~TRECSALVALUE" & strRSepApp).Width += +IIf(gridView.Columns("RBOXWT").Visible, gridView.Columns("RBOXWT").Width, 0) _
                       + IIf(gridView.Columns("RTOTWT").Visible, gridView.Columns("RTOTWT").Width, 0)
                    .Columns("RTAGS~RPCS~RGRSWT~RNETWT~TRECTAGS~TRECPCS~TRECGRSWT~TRECNETWT" & strRExtraWt & strRTagWt & strRCoverWt & "~RDIAPCS~RDIAWT~RSTNPCS~RSTNCRWT~RSTNGRWT~RTAGPCS~RVALUE~RSALVALUE~TRECDIAPCS~TRECDIAWT~TRECSTNPCS~TRECSTNCRWT~TRECSTNGRWT~TRECTAGPCS~TRECVALUE~TRECSALVALUE" & strRSepApp).Width += +IIf(gridView.Columns("TRECBOXWT").Visible, gridView.Columns("TRECBOXWT").Width, 0) _
                    + IIf(gridView.Columns("RTOTWT").Visible, gridView.Columns("RTOTWT").Width, 0)
                End If
            End If
            .Columns("RTAGS~RPCS~RGRSWT~RNETWT~TRECTAGS~TRECPCS~TRECGRSWT~TRECNETWT" & strRExtraWt & strRTagWt & strRCoverWt & "~RDIAPCS~RDIAWT~RSTNPCS~RSTNCRWT~RSTNGRWT~RTAGPCS~RVALUE~RSALVALUE~TRECDIAPCS~TRECDIAWT~TRECSTNPCS~TRECSTNCRWT~TRECSTNGRWT~TRECTAGPCS~TRECVALUE~TRECSALVALUE" & strRSepApp).Width += IIf(gridView.Columns("RDIAPCS").Visible, gridView.Columns("RDIAPCS").Width, 0) + IIf(gridView.Columns("RDIAWT").Visible, gridView.Columns("RDIAWT").Width, 0)
            .Columns("RTAGS~RPCS~RGRSWT~RNETWT~TRECTAGS~TRECPCS~TRECGRSWT~TRECNETWT" & strRExtraWt & strRTagWt & strRCoverWt & "~RDIAPCS~RDIAWT~RSTNPCS~RSTNCRWT~RSTNGRWT~RTAGPCS~RVALUE~RSALVALUE~TRECDIAPCS~TRECDIAWT~TRECSTNPCS~TRECSTNCRWT~TRECSTNGRWT~TRECTAGPCS~TRECVALUE~TRECSALVALUE" & strRSepApp).Width += IIf(gridView.Columns("TRECDIAPCS").Visible, gridView.Columns("TRECDIAPCS").Width, 0) + IIf(gridView.Columns("TRECDIAWT").Visible, gridView.Columns("TRECDIAWT").Width, 0)
            .Columns("RTAGS~RPCS~RGRSWT~RNETWT~TRECTAGS~TRECPCS~TRECGRSWT~TRECNETWT" & strRExtraWt & strRTagWt & strRCoverWt & "~RDIAPCS~RDIAWT~RSTNPCS~RSTNCRWT~RSTNGRWT~RTAGPCS~RVALUE~RSALVALUE~TRECDIAPCS~TRECDIAWT~TRECSTNPCS~TRECSTNCRWT~TRECSTNGRWT~TRECTAGPCS~TRECVALUE~TRECSALVALUE" & strRSepApp).Width += IIf(gridView.Columns("RSTNPCS").Visible, gridView.Columns("RSTNPCS").Width, 0) + IIf(gridView.Columns("RSTNCRWT").Visible, gridView.Columns("RSTNCRWT").Width, 0) + IIf(gridView.Columns("RSTNGRWT").Visible, gridView.Columns("RSTNGRWT").Width, 0)
            .Columns("RTAGS~RPCS~RGRSWT~RNETWT~TRECTAGS~TRECPCS~TRECGRSWT~TRECNETWT" & strRExtraWt & strRTagWt & strRCoverWt & "~RDIAPCS~RDIAWT~RSTNPCS~RSTNCRWT~RSTNGRWT~RTAGPCS~RVALUE~RSALVALUE~TRECDIAPCS~TRECDIAWT~TRECSTNPCS~TRECSTNCRWT~TRECSTNGRWT~TRECTAGPCS~TRECVALUE~TRECSALVALUE" & strRSepApp).Width += IIf(gridView.Columns("TRECSTNPCS").Visible, gridView.Columns("TRECSTNPCS").Width, 0) + IIf(gridView.Columns("TRECSTNCRWT").Visible, gridView.Columns("TRECSTNCRWT").Width, 0) + IIf(gridView.Columns("TRECSTNGRWT").Visible, gridView.Columns("TRECSTNGRWT").Width, 0)
            .Columns("RTAGS~RPCS~RGRSWT~RNETWT~TRECTAGS~TRECPCS~TRECGRSWT~TRECNETWT" & strRExtraWt & strRTagWt & strRCoverWt & "~RDIAPCS~RDIAWT~RSTNPCS~RSTNCRWT~RSTNGRWT~RTAGPCS~RVALUE~RSALVALUE~TRECDIAPCS~TRECDIAWT~TRECSTNPCS~TRECSTNCRWT~TRECSTNGRWT~TRECTAGPCS~TRECVALUE~TRECSALVALUE" & strRSepApp).Width += IIf(gridView.Columns("RVALUE").Visible, gridView.Columns("RVALUE").Width, 0) + IIf(gridView.Columns("RSALVALUE").Visible, gridView.Columns("RSALVALUE").Width, 0)
            .Columns("RTAGS~RPCS~RGRSWT~RNETWT~TRECTAGS~TRECPCS~TRECGRSWT~TRECNETWT" & strRExtraWt & strRTagWt & strRCoverWt & "~RDIAPCS~RDIAWT~RSTNPCS~RSTNCRWT~RSTNGRWT~RTAGPCS~RVALUE~RSALVALUE~TRECDIAPCS~TRECDIAWT~TRECSTNPCS~TRECSTNCRWT~TRECSTNGRWT~TRECTAGPCS~TRECVALUE~TRECSALVALUE" & strRSepApp).Width += IIf(gridView.Columns("RVALUE").Visible, gridView.Columns("RVALUE").Width, 0) + IIf(gridView.Columns("TRECSALVALUE").Visible, gridView.Columns("TRECSALVALUE").Width, 0)

            If chkSeperateColumnApproval.Checked And chkOnlyApproval.Checked = False Then
                .Columns("RTAGS~RPCS~RGRSWT~RNETWT~TRECTAGS~TRECPCS~TRECGRSWT~TRECNETWT" & strRExtraWt & strRTagWt & strRCoverWt & "~RDIAPCS~RDIAWT~RSTNPCS~RSTNCRWT~RSTNGRWT~RTAGPCS~RVALUE~RSALVALUE~TRECDIAPCS~TRECDIAWT~TRECSTNPCS~TRECSTNCRWT~TRECSTNGRWT~TRECTAGPCS~TRECVALUE~TRECSALVALUE" & strRSepApp).Width += gridView.Columns("ARRPCS").Width
                If ChkWithTag.Checked Then .Columns("RTAGS~RPCS~RGRSWT~RNETWT~TRECTAGS~TRECPCS~TRECGRSWT~TRECNETWT" & strRExtraWt & strRTagWt & strRCoverWt & "~RDIAPCS~RDIAWT~RSTNPCS~RSTNCRWT~RSTNGRWT~RTAGPCS~RVALUE~RSALVALUE~TRECDIAPCS~TRECDIAWT~TRECSTNPCS~TRECSTNCRWT~TRECSTNGRWT~TRECTAGPCS~TRECVALUE~TRECSALVALUE" & strRSepApp).Width += gridView.Columns("ARRTAGS").Width
                If chkGrsWt.Checked Then .Columns("RTAGS~RPCS~RGRSWT~RNETWT~TRECTAGS~TRECPCS~TRECGRSWT~TRECNETWT" & strRExtraWt & strRTagWt & strRCoverWt & "~RDIAPCS~RDIAWT~RSTNPCS~RSTNCRWT~RSTNGRWT~RTAGPCS~RVALUE~RSALVALUE~TRECDIAPCS~TRECDIAWT~TRECSTNPCS~TRECSTNCRWT~TRECSTNGRWT~TRECTAGPCS~TRECVALUE~TRECSALVALUE" & strRSepApp).Width += gridView.Columns("ARRGRSWT").Width
                If chkNetWt.Checked Then .Columns("RTAGS~RPCS~RGRSWT~RNETWT~TRECTAGS~TRECPCS~TRECGRSWT~TRECNETWT" & strRExtraWt & strRTagWt & strRCoverWt & "~RDIAPCS~RDIAWT~RSTNPCS~RSTNCRWT~RSTNGRWT~RTAGPCS~RVALUE~RSALVALUE~TRECDIAPCS~TRECDIAWT~TRECSTNPCS~TRECSTNCRWT~TRECSTNGRWT~TRECTAGPCS~TRECVALUE~TRECSALVALUE" & strRSepApp).Width += gridView.Columns("ARRNETWT").Width
                If chkExtraWt.Checked Then .Columns("RTAGS~RPCS~RGRSWT~RNETWT~TRECTAGS~TRECPCS~TRECGRSWT~TRECNETWT" & strRExtraWt & strRTagWt & strRCoverWt & "~RDIAPCS~RDIAWT~RSTNPCS~RSTNCRWT~RSTNGRWT~RTAGPCS~RVALUE~RSALVALUE~TRECDIAPCS~TRECDIAWT~TRECSTNPCS~TRECSTNCRWT~TRECSTNGRWT~TRECTAGPCS~TRECVALUE~TRECSALVALUE" & strRSepApp).Width += gridView.Columns("ARREXTRAWT").Width
                If ChkTagWt.Checked Then .Columns("RTAGS~RPCS~RGRSWT~RNETWT~TRECTAGS~TRECPCS~TRECGRSWT~TRECNETWT" & strRExtraWt & strRTagWt & strRCoverWt & "~RDIAPCS~RDIAWT~RSTNPCS~RSTNCRWT~RSTNGRWT~RTAGPCS~RVALUE~RSALVALUE~TRECDIAPCS~TRECDIAWT~TRECSTNPCS~TRECSTNCRWT~TRECSTNGRWT~TRECTAGPCS~TRECVALUE~TRECSALVALUE" & strRSepApp).Width += gridView.Columns("ARRTAGWT").Width
                If ChkCoverWt.Checked Then .Columns("RTAGS~RPCS~RGRSWT~RNETWT~TRECTAGS~TRECPCS~TRECGRSWT~TRECNETWT" & strRExtraWt & strRTagWt & strRCoverWt & "~RDIAPCS~RDIAWT~RSTNPCS~RSTNCRWT~RSTNGRWT~RTAGPCS~RVALUE~RSALVALUE~TRECDIAPCS~TRECDIAWT~TRECSTNPCS~TRECSTNCRWT~TRECSTNGRWT~TRECTAGPCS~TRECVALUE~TRECSALVALUE" & strRSepApp).Width += gridView.Columns("ARRCOVERWT").Width
            End If

            .Columns("RTAGS~RPCS~RGRSWT~RNETWT~TRECTAGS~TRECPCS~TRECGRSWT~TRECNETWT" & strRExtraWt & strRTagWt & strRCoverWt & "~RDIAPCS~RDIAWT~RSTNPCS~RSTNCRWT~RSTNGRWT~RTAGPCS~RVALUE~RSALVALUE~TRECDIAPCS~TRECDIAWT~TRECSTNPCS~TRECSTNCRWT~TRECSTNGRWT~TRECTAGPCS~TRECVALUE~TRECSALVALUE" & strRSepApp).HeaderText = "RECEIPT"

            .Columns("ITAGS~IPCS~IGRSWT~INETWT~TISSTAGS~TISSPCS~TISSGRSWT~TISSNETWT" & strIExtraWt & strITagWt & strICoverWt & "~IDIAPCS~IDIAWT~ISTNPCS~ISTNCRWT~ISTNGRWT~ITAGPCS~IVALUE~ISALVALUE~TISSDIAPCS~TISSDIAWT~TISSSTNPCS~TISSSTNCRWT~TISSSTNGRWT~TISSTAGPCS~TISSVALUE~TISSSALVALUE" & strISepApp).Width = gridView.Columns("IPCS").Width
            If ChkWithTag.Checked Then .Columns("ITAGS~IPCS~IGRSWT~INETWT~TISSTAGS~TISSPCS~TISSGRSWT~TISSNETWT" & strIExtraWt & strITagWt & strICoverWt & "~IDIAPCS~IDIAWT~ISTNPCS~ISTNCRWT~ISTNGRWT~ITAGPCS~IVALUE~ISALVALUE~TISSDIAPCS~TISSDIAWT~TISSSTNPCS~TISSSTNCRWT~TISSSTNGRWT~TISSTAGPCS~TISSVALUE~TISSSALVALUE" & strISepApp).Width += gridView.Columns("ITAGS").Width
            If chkGrsWt.Checked Then .Columns("ITAGS~IPCS~IGRSWT~INETWT~TISSTAGS~TISSPCS~TISSGRSWT~TISSNETWT" & strIExtraWt & strITagWt & strICoverWt & "~IDIAPCS~IDIAWT~ISTNPCS~ISTNCRWT~ISTNGRWT~ITAGPCS~IVALUE~ISALVALUE~TISSDIAPCS~TISSDIAWT~TISSSTNPCS~TISSSTNCRWT~TISSSTNGRWT~TISSTAGPCS~TISSVALUE~TISSSALVALUE" & strISepApp).Width += gridView.Columns("IGRSWT").Width
            If chkNetWt.Checked Then .Columns("ITAGS~IPCS~IGRSWT~INETWT~TISSTAGS~TISSPCS~TISSGRSWT~TISSNETWT" & strIExtraWt & strITagWt & strICoverWt & "~IDIAPCS~IDIAWT~ISTNPCS~ISTNCRWT~ISTNGRWT~ITAGPCS~IVALUE~ISALVALUE~TISSDIAPCS~TISSDIAWT~TISSSTNPCS~TISSSTNCRWT~TISSSTNGRWT~TISSTAGPCS~TISSVALUE~TISSSALVALUE" & strISepApp).Width += gridView.Columns("INETWT").Width
            If chkExtraWt.Checked Then .Columns("ITAGS~IPCS~IGRSWT~INETWT~TISSTAGS~TISSPCS~TISSGRSWT~TISSNETWT" & strIExtraWt & strITagWt & strICoverWt & "~IDIAPCS~IDIAWT~ISTNPCS~ISTNCRWT~ISTNGRWT~ITAGPCS~IVALUE~ISALVALUE~TISSDIAPCS~TISSDIAWT~TISSSTNPCS~TISSSTNCRWT~TISSSTNGRWT~TISSTAGPCS~TISSVALUE~TISSSALVALUE" & strISepApp).Width += gridView.Columns("IEXTRAWT").Width
            If ChkTagWt.Checked Then .Columns("ITAGS~IPCS~IGRSWT~INETWT~TISSTAGS~TISSPCS~TISSGRSWT~TISSNETWT" & strIExtraWt & strITagWt & strICoverWt & "~IDIAPCS~IDIAWT~ISTNPCS~ISTNCRWT~ISTNGRWT~ITAGPCS~IVALUE~ISALVALUE~TISSDIAPCS~TISSDIAWT~TISSSTNPCS~TISSSTNCRWT~TISSSTNGRWT~TISSTAGPCS~TISSVALUE~TISSSALVALUE" & strISepApp).Width += gridView.Columns("ITAGWT").Width
            If ChkCoverWt.Checked Then .Columns("ITAGS~IPCS~IGRSWT~INETWT~TISSTAGS~TISSPCS~TISSGRSWT~TISSNETWT" & strIExtraWt & strITagWt & strICoverWt & "~IDIAPCS~IDIAWT~ISTNPCS~ISTNCRWT~ISTNGRWT~ITAGPCS~IVALUE~ISALVALUE~TISSDIAPCS~TISSDIAWT~TISSSTNPCS~TISSSTNCRWT~TISSSTNGRWT~TISSTAGPCS~TISSVALUE~TISSSALVALUE" & strISepApp).Width += gridView.Columns("ICOVERWT").Width
            If ChkWithTag.Checked Then .Columns("ITAGS~IPCS~IGRSWT~INETWT~TISSTAGS~TISSPCS~TISSGRSWT~TISSNETWT" & strIExtraWt & strITagWt & strICoverWt & "~IDIAPCS~IDIAWT~ISTNPCS~ISTNCRWT~ISTNGRWT~ITAGPCS~IVALUE~ISALVALUE~TISSDIAPCS~TISSDIAWT~TISSSTNPCS~TISSSTNCRWT~TISSSTNGRWT~TISSTAGPCS~TISSVALUE~TISSSALVALUE" & strISepApp).Width += gridView.Columns("TISSTAGS").Width
            If chkGrsWt.Checked Then .Columns("ITAGS~IPCS~IGRSWT~INETWT~TISSTAGS~TISSPCS~TISSGRSWT~TISSNETWT" & strIExtraWt & strITagWt & strICoverWt & "~IDIAPCS~IDIAWT~ISTNPCS~ISTNCRWT~ISTNGRWT~ITAGPCS~IVALUE~ISALVALUE~TISSDIAPCS~TISSDIAWT~TISSSTNPCS~TISSSTNCRWT~TISSSTNGRWT~TISSTAGPCS~TISSVALUE~TISSSALVALUE" & strISepApp).Width += gridView.Columns("TISSGRSWT").Width
            If chkNetWt.Checked Then .Columns("ITAGS~IPCS~IGRSWT~INETWT~TISSTAGS~TISSPCS~TISSGRSWT~TISSNETWT" & strIExtraWt & strITagWt & strICoverWt & "~IDIAPCS~IDIAWT~ISTNPCS~ISTNCRWT~ISTNGRWT~ITAGPCS~IVALUE~ISALVALUE~TISSDIAPCS~TISSDIAWT~TISSSTNPCS~TISSSTNCRWT~TISSSTNGRWT~TISSTAGPCS~TISSVALUE~TISSSALVALUE" & strISepApp).Width += gridView.Columns("TISSNETWT").Width
            If chkExtraWt.Checked Then .Columns("ITAGS~IPCS~IGRSWT~INETWT~TISSTAGS~TISSPCS~TISSGRSWT~TISSNETWT" & strIExtraWt & strITagWt & strICoverWt & "~IDIAPCS~IDIAWT~ISTNPCS~ISTNCRWT~ISTNGRWT~ITAGPCS~IVALUE~ISALVALUE~TISSDIAPCS~TISSDIAWT~TISSSTNPCS~TISSSTNCRWT~TISSSTNGRWT~TISSTAGPCS~TISSVALUE~TISSSALVALUE" & strISepApp).Width += gridView.Columns("TISSEXTRAWT").Width
            If ChkTagWt.Checked Then .Columns("ITAGS~IPCS~IGRSWT~INETWT~TISSTAGS~TISSPCS~TISSGRSWT~TISSNETWT" & strIExtraWt & strITagWt & strICoverWt & "~IDIAPCS~IDIAWT~ISTNPCS~ISTNCRWT~ISTNGRWT~ITAGPCS~IVALUE~ISALVALUE~TISSDIAPCS~TISSDIAWT~TISSSTNPCS~TISSSTNCRWT~TISSSTNGRWT~TISSTAGPCS~TISSVALUE~TISSSALVALUE" & strISepApp).Width += gridView.Columns("TISSTAGWT").Width
            If ChkCoverWt.Checked Then .Columns("ITAGS~IPCS~IGRSWT~INETWT~TISSTAGS~TISSPCS~TISSGRSWT~TISSNETWT" & strIExtraWt & strITagWt & strICoverWt & "~IDIAPCS~IDIAWT~ISTNPCS~ISTNCRWT~ISTNGRWT~ITAGPCS~IVALUE~ISALVALUE~TISSDIAPCS~TISSDIAWT~TISSSTNPCS~TISSSTNCRWT~TISSSTNGRWT~TISSTAGPCS~TISSVALUE~TISSSALVALUE" & strISepApp).Width += gridView.Columns("TISSCOVERWT").Width
            If chkSummary.Checked And (ChkCoverWt.Checked Or ChkTagWt.Checked) Then
                If Mid(grpby, 2, Len(grpby)) = "CU" Then
                    .Columns("ITAGS~IPCS~IGRSWT~INETWT~TISSTAGS~TISSPCS~TISSGRSWT~TISSNETWT" & strIExtraWt & strITagWt & strICoverWt & "~IDIAPCS~IDIAWT~ISTNPCS~ISTNCRWT~ISTNGRWT~ITAGPCS~IVALUE~ISALVALUE~TISSDIAPCS~TISSDIAWT~TISSSTNPCS~TISSSTNCRWT~TISSSTNGRWT~TISSTAGPCS~TISSVALUE~TISSSALVALUE" & strISepApp).Width += IIf(gridView.Columns("IBOXWT").Visible, gridView.Columns("IBOXWT").Width, 0) _
                    + IIf(gridView.Columns("ITOTWT").Visible, gridView.Columns("ITOTWT").Width, 0)
                    .Columns("ITAGS~IPCS~IGRSWT~INETWT~TISSTAGS~TISSPCS~TISSGRSWT~TISSNETWT" & strIExtraWt & strITagWt & strICoverWt & "~IDIAPCS~IDIAWT~ISTNPCS~ISTNCRWT~ISTNGRWT~ITAGPCS~IVALUE~ISALVALUE~TISSDIAPCS~TISSDIAWT~TISSSTNPCS~TISSSTNCRWT~TISSSTNGRWT~TISSTAGPCS~TISSVALUE~TISSSALVALUE" & strISepApp).Width += IIf(gridView.Columns("TISSBOXWT").Visible, gridView.Columns("TISSBOXWT").Width, 0) _
                    + IIf(gridView.Columns("ITOTWT").Visible, gridView.Columns("ITOTWT").Width, 0)
                End If
            End If
            .Columns("ITAGS~IPCS~IGRSWT~INETWT~TISSTAGS~TISSPCS~TISSGRSWT~TISSNETWT" & strIExtraWt & strITagWt & strICoverWt & "~IDIAPCS~IDIAWT~ISTNPCS~ISTNCRWT~ISTNGRWT~ITAGPCS~IVALUE~ISALVALUE~TISSDIAPCS~TISSDIAWT~TISSSTNPCS~TISSSTNCRWT~TISSSTNGRWT~TISSTAGPCS~TISSVALUE~TISSSALVALUE" & strISepApp).Width += IIf(gridView.Columns("IDIAPCS").Visible, gridView.Columns("IDIAPCS").Width, 0) + IIf(gridView.Columns("IDIAWT").Visible, gridView.Columns("IDIAWT").Width, 0)
            .Columns("ITAGS~IPCS~IGRSWT~INETWT~TISSTAGS~TISSPCS~TISSGRSWT~TISSNETWT" & strIExtraWt & strITagWt & strICoverWt & "~IDIAPCS~IDIAWT~ISTNPCS~ISTNCRWT~ISTNGRWT~ITAGPCS~IVALUE~ISALVALUE~TISSDIAPCS~TISSDIAWT~TISSSTNPCS~TISSSTNCRWT~TISSSTNGRWT~TISSTAGPCS~TISSVALUE~TISSSALVALUE" & strISepApp).Width += IIf(gridView.Columns("ISTNPCS").Visible, gridView.Columns("ISTNPCS").Width, 0) + IIf(gridView.Columns("ISTNCRWT").Visible, gridView.Columns("ISTNCRWT").Width, 0) + IIf(gridView.Columns("ISTNGRWT").Visible, gridView.Columns("ISTNGRWT").Width, 0)
            .Columns("ITAGS~IPCS~IGRSWT~INETWT~TISSTAGS~TISSPCS~TISSGRSWT~TISSNETWT" & strIExtraWt & strITagWt & strICoverWt & "~IDIAPCS~IDIAWT~ISTNPCS~ISTNCRWT~ISTNGRWT~ITAGPCS~IVALUE~ISALVALUE~TISSDIAPCS~TISSDIAWT~TISSSTNPCS~TISSSTNCRWT~TISSSTNGRWT~TISSTAGPCS~TISSVALUE~TISSSALVALUE" & strISepApp).Width += IIf(gridView.Columns("IVALUE").Visible, gridView.Columns("IVALUE").Width, 0) + IIf(gridView.Columns("ISALVALUE").Visible, gridView.Columns("ISALVALUE").Width, 0)
            .Columns("ITAGS~IPCS~IGRSWT~INETWT~TISSTAGS~TISSPCS~TISSGRSWT~TISSNETWT" & strIExtraWt & strITagWt & strICoverWt & "~IDIAPCS~IDIAWT~ISTNPCS~ISTNCRWT~ISTNGRWT~ITAGPCS~IVALUE~ISALVALUE~TISSDIAPCS~TISSDIAWT~TISSSTNPCS~TISSSTNCRWT~TISSSTNGRWT~TISSTAGPCS~TISSVALUE~TISSSALVALUE" & strISepApp).Width += IIf(gridView.Columns("TISSDIAPCS").Visible, gridView.Columns("TISSDIAPCS").Width, 0) + IIf(gridView.Columns("TISSDIAWT").Visible, gridView.Columns("TISSDIAWT").Width, 0)
            .Columns("ITAGS~IPCS~IGRSWT~INETWT~TISSTAGS~TISSPCS~TISSGRSWT~TISSNETWT" & strIExtraWt & strITagWt & strICoverWt & "~IDIAPCS~IDIAWT~ISTNPCS~ISTNCRWT~ISTNGRWT~ITAGPCS~IVALUE~ISALVALUE~TISSDIAPCS~TISSDIAWT~TISSSTNPCS~TISSSTNCRWT~TISSSTNGRWT~TISSTAGPCS~TISSVALUE~TISSSALVALUE" & strISepApp).Width += IIf(gridView.Columns("TISSSTNPCS").Visible, gridView.Columns("TISSSTNPCS").Width, 0) + IIf(gridView.Columns("TISSSTNCRWT").Visible, gridView.Columns("TISSSTNCRWT").Width, 0) + IIf(gridView.Columns("TISSSTNGRWT").Visible, gridView.Columns("TISSSTNGRWT").Width, 0)
            .Columns("ITAGS~IPCS~IGRSWT~INETWT~TISSTAGS~TISSPCS~TISSGRSWT~TISSNETWT" & strIExtraWt & strITagWt & strICoverWt & "~IDIAPCS~IDIAWT~ISTNPCS~ISTNCRWT~ISTNGRWT~ITAGPCS~IVALUE~ISALVALUE~TISSDIAPCS~TISSDIAWT~TISSSTNPCS~TISSSTNCRWT~TISSSTNGRWT~TISSTAGPCS~TISSVALUE~TISSSALVALUE" & strISepApp).Width += IIf(gridView.Columns("TISSVALUE").Visible, gridView.Columns("TISSVALUE").Width, 0) + IIf(gridView.Columns("TISSSALVALUE").Visible, gridView.Columns("TISSSALVALUE").Width, 0)

            If chkSeperateColumnApproval.Checked And chkOnlyApproval.Checked = False Then
                .Columns("ITAGS~IPCS~IGRSWT~INETWT~TISSTAGS~TISSPCS~TISSGRSWT~TISSNETWT" & strIExtraWt & strITagWt & strICoverWt & "~IDIAPCS~IDIAWT~ISTNPCS~ISTNCRWT~ISTNGRWT~ITAGPCS~IVALUE~ISALVALUE~TISSDIAPCS~TISSDIAWT~TISSSTNPCS~TISSSTNCRWT~TISSSTNGRWT~TISSTAGPCS~TISSVALUE~TISSSALVALUE" & strISepApp).Width += gridView.Columns("AIIPCS").Width
                If ChkWithTag.Checked Then .Columns("ITAGS~IPCS~IGRSWT~INETWT~TISSTAGS~TISSPCS~TISSGRSWT~TISSNETWT" & strIExtraWt & strITagWt & strICoverWt & "~IDIAPCS~IDIAWT~ISTNPCS~ISTNCRWT~ISTNGRWT~ITAGPCS~IVALUE~ISALVALUE~TISSDIAPCS~TISSDIAWT~TISSSTNPCS~TISSSTNCRWT~TISSSTNGRWT~TISSTAGPCS~TISSVALUE~TISSSALVALUE" & strISepApp).Width += gridView.Columns("AIITAGS").Width
                If chkGrsWt.Checked Then .Columns("ITAGS~IPCS~IGRSWT~INETWT~TISSTAGS~TISSPCS~TISSGRSWT~TISSNETWT" & strIExtraWt & strITagWt & strICoverWt & "~IDIAPCS~IDIAWT~ISTNPCS~ISTNCRWT~ISTNGRWT~ITAGPCS~IVALUE~ISALVALUE~TISSDIAPCS~TISSDIAWT~TISSSTNPCS~TISSSTNCRWT~TISSSTNGRWT~TISSTAGPCS~TISSVALUE~TISSSALVALUE" & strISepApp).Width += gridView.Columns("AIIGRSWT").Width
                If chkNetWt.Checked Then .Columns("ITAGS~IPCS~IGRSWT~INETWT~TISSTAGS~TISSPCS~TISSGRSWT~TISSNETWT" & strIExtraWt & strITagWt & strICoverWt & "~IDIAPCS~IDIAWT~ISTNPCS~ISTNCRWT~ISTNGRWT~ITAGPCS~IVALUE~ISALVALUE~TISSDIAPCS~TISSDIAWT~TISSSTNPCS~TISSSTNCRWT~TISSSTNGRWT~TISSTAGPCS~TISSVALUE~TISSSALVALUE" & strISepApp).Width += gridView.Columns("AIINETWT").Width
                If chkExtraWt.Checked Then .Columns("ITAGS~IPCS~IGRSWT~INETWT~TISSTAGS~TISSPCS~TISSGRSWT~TISSNETWT" & strIExtraWt & strITagWt & strICoverWt & "~IDIAPCS~IDIAWT~ISTNPCS~ISTNCRWT~ISTNGRWT~ITAGPCS~IVALUE~ISALVALUE~TISSDIAPCS~TISSDIAWT~TISSSTNPCS~TISSSTNCRWT~TISSSTNGRWT~TISSTAGPCS~TISSVALUE~TISSSALVALUE" & strISepApp).Width += gridView.Columns("AIIEXTRAWT").Width
                If ChkTagWt.Checked Then .Columns("ITAGS~IPCS~IGRSWT~INETWT~TISSTAGS~TISSPCS~TISSGRSWT~TISSNETWT" & strIExtraWt & strITagWt & strICoverWt & "~IDIAPCS~IDIAWT~ISTNPCS~ISTNCRWT~ISTNGRWT~ITAGPCS~IVALUE~ISALVALUE~TISSDIAPCS~TISSDIAWT~TISSSTNPCS~TISSSTNCRWT~TISSSTNGRWT~TISSTAGPCS~TISSVALUE~TISSSALVALUE" & strISepApp).Width += gridView.Columns("AIITAGWT").Width
                If ChkCoverWt.Checked Then .Columns("ITAGS~IPCS~IGRSWT~INETWT~TISSTAGS~TISSPCS~TISSGRSWT~TISSNETWT" & strIExtraWt & strITagWt & strICoverWt & "~IDIAPCS~IDIAWT~ISTNPCS~ISTNCRWT~ISTNGRWT~ITAGPCS~IVALUE~ISALVALUE~TISSDIAPCS~TISSDIAWT~TISSSTNPCS~TISSSTNCRWT~TISSSTNGRWT~TISSTAGPCS~TISSVALUE~TISSSALVALUE" & strISepApp).Width += gridView.Columns("AIICOVERWT").Width
            End If
            .Columns("ITAGS~IPCS~IGRSWT~INETWT~TISSTAGS~TISSPCS~TISSGRSWT~TISSNETWT" & strIExtraWt & strITagWt & strICoverWt & "~IDIAPCS~IDIAWT~ISTNPCS~ISTNCRWT~ISTNGRWT~ITAGPCS~IVALUE~ISALVALUE~TISSDIAPCS~TISSDIAWT~TISSSTNPCS~TISSSTNCRWT~TISSSTNGRWT~TISSTAGPCS~TISSVALUE~TISSSALVALUE" & strISepApp).HeaderText = "ISSUE"
    ...
    Private Sub frmItemWiseStock_Format1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Prop_Sets()
        Dim obj As New frmItemWiseStock_Format1_Properties
        ...
        SetSettingsObj(obj, Me.Name, GetType(frmItemWiseStock_Format1_Properties), Save)
    End Sub

    Private Sub Prop_Gets()
        Dim obj As New frmItemWiseStock_Format1_Properties
        GetSettingsObj(obj, Me.Name, GetType(frmItemWiseStock_Format1_Properties), IIf(Authorize = False, True, False))
    ...
    Private Sub StoneDetails()
        ...
        strSql += vbCrLf + " ,@WITHAPP = '" & IIf(chkSeperateColumnApproval.Checked, "Y", "N") & "'"
        strSql += vbCrLf + " ,@SHORTNAME = '" & IIf(chkShortname.Checked, "Y", "N") & "'"
        strSql += vbCrLf + " ,@ORDERBY = '" & IIf(chkOrderbyItemId.Checked, "Y", "N") & "'"
        strSql += vbCrLf + " ,@HIDEBACKOFF = '" & IIf(_HideBackOffice = True, "Y", "N") & "'"
        If ChkLstGroupBy.CheckedItems.Contains("COUNTER") Then
...
Public Class frmItemWiseStock_Format1_Properties
