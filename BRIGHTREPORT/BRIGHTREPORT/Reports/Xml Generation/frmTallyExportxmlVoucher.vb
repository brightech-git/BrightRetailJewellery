...
Public Class frmTallyExportxmlVoucher
#Region "VARIABLE"
    ...
    Private Sub btnExport_Click(sender As Object, e As EventArgs) Handles btnExport.Click
        ...
        Try
            Using writer As XmlWriter = XmlWriter.Create(Path, settings) 'E:\employees.xml
                ...
                writer.WriteElementString("SVCURRENTCOMPANY", "" & strCompanyName & " 2018-2019") '
                ...
                writer.WriteElementString("REMOTECMPNAME", "" & strCompanyName & "  2018-2019")
