...
Public Class frmMIMRInitialize
    ...
    Private Sub btnOk_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOk.Click
        ...
        If counterName = Nothing Then
            ...
            Exit Sub
        End If
        Dim pwd As String = objGPack.GetSqlValue("SELECT PASSWORD FROM " & cnAdminDb & "..CASHCOUNTER WHERE CASHNAME = '" & cmbCashCounter.Text & "' AND PASSWORD = '" & BrighttechPack.Methods.Encrypt(txtPassword.Text) & "'", , Nothing)
        ...
        strSql = " select * from " & cnAdminDb & "..CashCounter where CashName = '" & cmbCashCounter.Text & "' and Password = '" & BrighttechPack.Methods.Encrypt(txtPassword.Text) & "'"
        ...
        txtPassword.Clear()
        dtpBillDate.Focus()
        BrighttechPack.LanguageChange.Set_Language_Form(objMIMR, LangId)
