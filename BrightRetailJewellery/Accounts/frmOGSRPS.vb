...
Public Class frmOGSRPS
    ...
    Function funcOpen() As Integer
        If Not GiritechPack.Methods.GetRights(_DtUserRights, Me.Name, GiritechPack.Methods.RightMode.View) Then Exit Function
...
GENLOTNO:
            ...
            For cnt As Integer = 0 To itemDt.Rows.Count - 1
                With itemDt.Rows(cnt)
                    ...
                    End Select
                    strSql = " INSERT INTO " & cnStockDb & "..ITEMLOT"
                    strSql += " ("
                    ...
                    strSql += " UPTIME,SYSTEMID,APPVER,TABLECODE)VALUES("
                    strSql += " '" & GetNewSno(TranSnoType.ITEMLOTCODE, tran, "GET_TRANSNO_ADMIN") & "'" 'SNO
    ...
    Private Sub InsertintoNonTag(ByVal upRow As DataRow)
        ...
        strSql = " INSERT INTO " & cnStockDb & "..ITEMNONTAG"
        strSql += " ("
        ...
        strSql += " Values"
        strSql += " ("
        strSql += " '" & GetNewSno(TranSnoType.ITEMNONTAGCODE, tran, "GET_TRANSNO_ADMIN") & "'" 'SNO
        ...
        strSql += " ,'" & objGPack.GetSqlValue("SELECT COSTID FROM " & cnAdminDb & "..COSTCENTRE WHERE COSTNAME = '" & upRow!COSTCENTRE.ToString & "'", , , tran) & "'" 'COSTID
        strSql += " ,''" 'CtGrm
        strSql += " ,0" 'DesignerId
        strSql += " ,'Y'" 'VATEXM
        ...
        strSql += " ,'" & VERSION & "'" 'APPVER
        strSql += " )"
        ExecQuery(SyncMode.Stock, strSql, cn, tran, objGPack.GetSqlValue("SELECT COSTID FROM " & cnAdminDb & "..COSTCENTRE WHERE COSTNAME = '" & upRow!COSTCENTRE.ToString & "'", , , tran))
    End Sub
        ...
        With itemDt.Rows(0)
            ...
            Select Case .Item("ENTRYTYPE").ToString.ToUpper
                ...
                Case Else 'NONTAG TO TAG
                    entryType = "NT"
            End Select
            strSql = " UPDATE " & cnStockDb & "..ITEMLOT SET "
            ...
            strSql += " ,TABLECODE = '" & .Item("TABLECODE").ToString & "'"
    ...
    Private Sub frmLotEntry_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        strSql += " ''ORDENTRYORDER,'' AS ITEMCTRNAME,''VALUEADDEDTYPE,''BULKLOT,''MULTIPLETAGS,''NARRATION,"
        strSql += " ''FINERATE,''TUCH,''WASTPER,''MCGRM,''OTHCHARGE,''NONTAGITEM,''NONTAGSUBITEM,''NONTAGPCS,''NONTAGGRSWT,''NONTAGITEMCTRID,''TABLECODE,''TOORDER"
        da = New OleDbDataAdapter(strSql, cn)
        da.Fill(itemDt)
    ...
    Private Sub txtItemCode_Num_Man_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    Function GetNontagdetails() As Boolean
        ...
        strSql += " FROM " & cnStockDb & "..ITEMNONTAG T"
        strSql += " WHERE ITEMID = " & mdefItemid
        ...
        If Not (AZP And dt.Rows.Count = 0) Then
            If dt.Rows.Count > 1 Then
                ...
                retRow = GiritechPack.SearchDialog.Show_R("Select Counter Detail", strSql, cn, , , , , , , True)
            ...
            For Each ro As DataRow In itemDt.Rows
                If ro!NONTAGITEM.ToString = txtNonTagItem.Text Then
        ...
        Return True
    End Function
    Private Sub txtItemCode_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If e.KeyCode = Keys.Insert Then  'Insert Key
            ...
            txtItemCode_Num_Man.Text = GiritechPack.SearchDialog.Show("Search ItemId", strSql, cn, 1)
        ...
        End If
    End Sub
    Private Sub txtNoOfTags_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    End Sub
    Private Sub txtNoOfTags_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        ...
        End If
    End Sub
    Private Sub cmbStoneUnit_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs)
        CalcNetWt()
    End Sub
    ...
    Private Sub txtDidmondWeight_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        CalcNetWt()
    End Sub

    Private Sub cmbEntryType_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If e.KeyChar = Chr(Keys.Enter) Then
            ...
            If cmbEntryType.Text = "NONTAG TO TAG" Then
                ...
                txtNonTagItem.Text = GiritechPack.SearchDialog.Show("Find ItemName", strSql, cn, 1, 1, , txtNonTagItem.Text, , , True)
                ...
                txtNonTagSubItem.Text = GiritechPack.SearchDialog.Show("Search SubItem", strSql, cn, IIf(_SubItemOrderByName, 2, 1), 2, , DefItem, , False, True)
                'txtNonTagSubItem.Text = GiritechPack.SearchDialog.Show("Find SubItem", "SELECT SUBITEMID ID,SUBITEMNAME SUBITEM FROM " & cnAdminDb & "..SUBITEMMAST WHERE ITEMID = " & Val(objGPack.GetSqlValue("SELECT ITEMID FROM " & cnAdminDb & "..ITEMMAST WHERE ITEMNAME = '" & txtNonTagItem.Text & "'")) & " AND ACTIVE = 'Y'", cn, 1, 1, , txtNonTagSubItem.Text, , False, True)
    ...
    Private Sub cmbEntryType_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        ''Order/Repair only
    ...
    Private Sub txtOpenItemName_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtOpenItemName.KeyDown
        If e.KeyCode = Keys.Insert Then 'Ins Key
            ...
            strSql += GetItemQryFilteration("S")
            strSql += " ORDER BY ITEMNAME"
            txtOpenItemName.Text = GiritechPack.SearchDialog.Show("Find ItemName", strSql, cn, 1, 1)
        End If
    End Sub
    Private Sub btnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        strSql += " ACCESSING,TABLECODE FROM " & cnStockDb & "..ITEMLOT AS LOT"
        strSql += " WHERE 1=1"
        If txtOpenLotNo.Text <> "" Then
    ...
    Private Sub cmbSubItemName_Man_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs)
        If tagMade Then
            SendKeys.Send("{TAB}")
        End If
    End Sub

    Private Sub cmbSubItemName_Man_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    Private Sub cmbSubItemName_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    Private Sub gridViewOpen_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles gridViewOpen.KeyPress
        If e.KeyChar = Chr(Keys.Enter) Then
            ...
            If Not GiritechPack.Methods.GetRights(_DtUserRights, Me.Name, GiritechPack.Methods.RightMode.Edit) Then Exit Sub
            'strSql = " SELECT"
            ...
            'strSql += " CASE WHEN WASTPER <> 0 THEN WASTPER ELSE NULL END WASTPER,CASE WHEN MCGRM <> 0 THEN MCGRM ELSE NULL END MCGRM,CASE WHEN OTHCHARGE <> 0 THEN OTHCHARGE ELSE NULL END OTHCHARGE,STARTTAGNO,ENDTAGNO,CURTAGNO,"
            'strSql += " COMPANYID,CASE WHEN CPCS <> 0 THEN CPCS ELSE NULL END CPCS,CASE WHEN CGRSWT <> 0 THEN CGRSWT ELSE NULL END CGRSWT,COMPLETED,CANCEL,VATEXM,"
            'strSql += " ACCESSING FROM " & cnStockDb & "..ITEMLOT AS LOT"
            With gridViewOpen.Rows(gridViewOpen.CurrentRow.Index)
                ...
                End If
                strSql = " SELECT 1 COL1 FROM " & cnStockDb & "..ORIRDETAIL WHERE ISNULL(ORSNO,'') IN"
                strSql += vbCrLf + " (SELECT ORSNO FROM " & cnStockDb & "..ITEMTAG WHERE LOTSNO = '" & .Cells("SNO").Value.ToString & "')"
                If Not GiritechPack.GetSqlValue(cn, strSql, "COL1", "") = "" Then
                    txtOrderRepairNo.Enabled = False
                Else
                    txtOrderRepairNo.Enabled = True
                End If
                ...
                If objGPack.GetSqlValue("SELECT TAGNO FROM " & cnStockDb & "..ITEMTAG WHERE LOTSNO = '" & updSno & "'") <> "" Then
                    tagMade = True
                Else
                    tagMade = False
                End If
    ...
    Private Sub txtGrossWeight_Wet_MAN_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs)
        If Val(txtGrossWeight_Wet.Text) = 0 Then
    ...
    Private Sub txtGrossWeight_Wet_MAN_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
    ...
    Private Sub txtGrossWeight_Wet_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If flagUpdate = False Then
            ...
            Dim SubItemId As String = GiritechPack.GetSqlValue(cn, strSql, "SUBITEMID", "")
            ...
            'Dim Accode As String = GiritechPack.GetSqlValue(cn, strSql, "ACCODE", "")
            'strSql = " SELECT SUBITEMID FROM " & cnAdminDb & "..SUBITEMMAST WHERE ISNULL(ITEMID,'') = '" + txtItemCode_Num_Man.Text + "' AND ISNULL(SUBITEMNAME,'') = '" + cmbSubItemName_Man.Text + "'"
            'Dim SubItemId As String = GiritechPack.GetSqlValue(cn, strSql, "SUBITEMID", "")
    ...
    Private Sub txtItemCode_Num_Man_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
    ...
    Private Sub txtNetWeight_Wet_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs)
        If Val(txtGrossWeight_Wet.Text) = 0 Then
            SendKeys.Send("{TAB}")
        End If
        CalcNetWt()
    ...
    Private Sub txtDidmondWeight_Wet_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs)
        CalcNetWt()
    End Sub
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        ...
        If (cmbEntryType.Text = "ORDER" Or cmbEntryType.Text = "REPAIR") And txtOrderRepairNo.Text <> "" Then
            strSql = " SELECT 1 CHKCOL FROM " & cnStockDb & "..ORMAST AS I"
            strSql += " WHERE NOT EXISTS (SELECT 1 FROM " & cnStockDb & "..ORIRDETAIL WHERE ORSTATUS = 'R' AND ORSNO = I.SNO  AND ISNULL(CANCEL,'') = '' AND ORDSTATE_ID = 4)"
    ...
    Private Sub txtItemRate_Amt_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If e.KeyChar = Chr(Keys.Enter) Then
    ...
    Private Sub txtNetWeight_Wet_MAN_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    ...
    Private Sub txtItemCode_Num_Man_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs)
        Main.HideHelpText()
    ...
    Private Sub txtPiece_Num_Man_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        'If cmbEntryType.Text = "NONTAG TO TAG" Then
    ...
    Private Sub txtWastage_Per_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs)
        If Val(txtTuch_Amt.Text) >= 0 Then
            SendKeys.Send("{TAB}")
        End If
    End Sub

    Private Sub cmbSupplier_Man_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    Private Sub txtPiece_Num_Man_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    Private Sub cmbValueAdded_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If e.KeyCode = Keys.Enter Then
    ...
    Private Sub cmbSupplier_Man_OWN_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If e.KeyCode = Keys.Insert Then  'Insert Key
            strSql = " SELECT DESIGNERID,DESIGNERNAME,SEAL"
            strSql += " FROM " & cnAdminDb & "..DESIGNER WHERE ISNULL(ACTIVE,'') <> 'N'"
            cmbSupplier_Man_OWN.Text = GiritechPack.SearchDialog.Show("Search DesignerName", strSql, cn, 2, 1)
            cmbSupplier_Man_OWN.SelectAll()
        End If
    End Sub

    Private Sub cmbSupplier_Man_OWN_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If e.KeyChar = Chr(Keys.Enter) Then
            If cmbSupplier_Man_OWN.Items.Contains(cmbSupplier_Man_OWN.Text) = False Then
                ...
                If desName = "" Then
                    ...
                    strSql += " FROM " & cnAdminDb & "..DESIGNER WHERE ISNULL(ACTIVE,'') <> 'N'"
                    cmbSupplier_Man_OWN.Text = GiritechPack.SearchDialog.Show("Search DesignerName", strSql, cn, 0, 2)
                    cmbSupplier_Man_OWN.SelectAll()
                Else
    ...
    Private Sub cmbSupplier_Man_OWN_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs)
        cmbSupplier_Man_OWN.BackColor = GlobalVariables.lostFocusColor
    End Sub

    Private Sub txtOrderRepairNo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If e.KeyCode = Keys.Insert Then
            If cmbEntryType.Text.ToString().ToUpper = "ORDER" Or cmbEntryType.Text.ToString().ToUpper = "REPAIR" Or MoveOrder = True Then
                'strSql = " SELECT DISTINCT SUBSTRING(ORNO,6,20) ORNO,ORDATE TRANDATE,SUBSTRING(ORNO,1,2) COSTID ,SUBSTRING(ORNO,3,3) COMPANYID FROM " & cnStockDb & "..ORIRDETAIL AS I"
                'strSql += " WHERE NOT EXISTS (SELECT 1 FROM " & cnStockDb & "..ORIRDETAIL WHERE ORSTATUS = 'R' AND ORSNO = I.ORSNO  AND ISNULL(CANCEL,'') = '' AND ORDSTATE_ID = 4)"
                ...
                strSql += ",IT.ITEMNAME AS ITEMNAME"
                strSql += " FROM " & cnStockDb & "..ORMAST AS I"
                strSql += " LEFT JOIN " & cnStockDb & "..CUSTOMERINFO AS C ON C.BATCHNO = I.BATCHNO"
                ...
                If cmbEntryType.Text.ToString().ToUpper = "ORDER" Or MoveOrder Then
                    ...
                    dr_Ord = GiritechPack.SearchDialog.Show_R("Select Order No", strSql, cn, , , , , , False)
                Else
                    strSql += " AND SUBSTRING(ORNO,6,1) = 'R'"
                    dr_Ord = GiritechPack.SearchDialog.Show_R("Select Repair No", strSql, cn, , , , , , False)
                End If
                If dr_Ord IsNot Nothing Then
                    ...
                    txtItemCode_Num_Man.Text = dtitemr.Item(0)
    ...
    Private Sub txtOrderRepairNo_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
            ...
            If txtOrderRepairNo.Text <> "" Then
                ...
                If cmbEntryType.Text.ToString().ToUpper = "ORDER" Or cmbEntryType.Text.ToString().ToUpper = "REPAIR" Or MoveOrder = True Then
                    ...
                    If dt_Ord.Rows.Count > 1 Then
                        dr_Ord = GiritechPack.SearchDialog.Show_R("Select Item ", strSql, cn, , , , , , False)
                        txtOrderRepairNo.Text = dr_Ord.Item("ORNO").ToString
                        OrdCostId = dr_Ord.Item("COSTID").ToString
                        OrdCompanyId = dr_Ord.Item("COMPANYID").ToString
    ...
    Private Sub txtOrderRepairNo_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs)
        If txtOrderRepairNo.Text = "" Then
            OrdRepairNo = ""
        Else
            OrdRepairNo = OrdCostId + OrdCompanyId + txtOrderRepairNo.Text
        End If
    End Sub

    Private Sub txtPiece_Num_Man_Enter(ByVal sender As System.Object, ByVal e As System.EventArgs)
        'strSql = "SELECT ALLOWZEROPCS FROM " & cnAdminDb & "..ITEMMAST WHERE ITEMID='" & txtItemCode_Num_Man.Text & "'"
        'Dim dt As New DataTable
        'da = New OleDbDataAdapter(strSql, cn)
        'da.Fill(dt)
    ...
    Private Sub txtPiece_Num_Man_Leave(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub txtItemCode_Num_Man_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub txtBillNo_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
