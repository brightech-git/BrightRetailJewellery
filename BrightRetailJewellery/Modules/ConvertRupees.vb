Module ConvertRupees
    Function RupeesToWord(ByVal MyNumber As Object, Optional ByVal Prefix As String = "Rupees", Optional ByVal Suffix As String = " Only")
        Dim Temp
        ...
        If Len(MyNumber) > 0 And Len(MyNumber) <= 2 Then
            If Len(TM) = 1 Then
                ...
                RupeesToWord = Prefix & " " & Words & Paisa & " " & Suffix
        ...
        RupeesToWord = Prefix & " " & Words & Hundreds & Paisa & " " & Suffix
    End Function
    ...
    Private Function ConvertHundreds(ByVal MyNumber)
        ...
        If Left(MyNumber, 1) <> "0" Then
            Result = ConvertDigit(Left(MyNumber, 1)) & " Hundred " 's
        End If
