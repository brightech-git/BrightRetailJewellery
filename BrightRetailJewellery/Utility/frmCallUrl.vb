...
Public Class frmCallUrl
    ...
    Private Sub btnView_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnView.Click
        ...
        strsql += vbCrLf & "  ,(SELECT SUM(AMOUNT) FROM " & cnStockDb & "..ACCTRAN WHERE BATCHNO = I.BATCHNO AND PAYMODE = 'CA') AS [RECEIVE]"
        ...
        cmd.ExecuteNonQuery()
        strsql = vbCrLf
        strsql += vbCrLf & "   INSERT INTO TEMPTABLEDB..TEMP_RSOFT (ACCODE,RECEIVE,ADVANCE,DUE,GIFTVOUCHER,SCHEME,CHEQUE,CREDITCARD,HANDCHARG,DISCOUNT,CASH ,COLHEAD, RESULT)"
        strsql += vbCrLf & "   SELECT 'TOTAL',SUM(RECEIVE),SUM(ADVANCE),SUM(DUE),SUM(GIFTVOUCHER),SUM(SCHEME),SUM(CHEQUE),SUM(CREDITCARD),SUM(HANDCHARG),SUM(DISCOUNT),SUM(CASH) "
