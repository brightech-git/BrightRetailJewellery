...
#Region "Add Control Newly"
    ...
    Public Sub AddControlToGridView1(ByVal Image As Image, ByVal transparencyColor As Color, ByVal position As Point, ByVal dt As DataTable)
        Dim gridview As New DataGridView
        gridview.Location = position
        gridview.Size = New System.Drawing.Size(460, 225)
        gridview.Name = "gridviewOTP"
        ...
        Next
        gridview.Columns("OPTIONAME").Width = 50
        gridview.Columns("GIVENBY").Width = 150
        gridview.Columns("NOOFOTP").Width = 50
        gridview.Columns("REMARKS").Width = 100
        'gridview.Columns("NAME").Width = 150
        gridview.Columns("NOOFOTP").DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
