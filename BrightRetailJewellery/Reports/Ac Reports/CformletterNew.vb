...
Public Class CformletterNew
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BrighttechRetailJewellery.CformletterNew.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCformletterNew
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CformletterNew = New CformletterNew()
        rpt.Site = Me.Site
        Return rpt
    End Function
