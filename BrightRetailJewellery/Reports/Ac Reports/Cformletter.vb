...
Public Class Cformletter
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BrighttechRetailJewellery.Cformletter.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCformletter
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cformletter = New Cformletter()
        rpt.Site = Me.Site
        Return rpt
    End Function
