...
Public Class Cformletter2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BrighttechRetailJewellery.Cformletter2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCformletter2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cformletter2 = New Cformletter2()
        rpt.Site = Me.Site
        Return rpt
    End Function
