...
Public Class frmTrialBal_Summary
    ...
    Private Sub frmTrailBal_Summary_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
        If e.KeyChar = Chr(Keys.Enter) Then
            SendKeys.Send("{TAB}")
        End If
    End Sub

    Private Sub frmTrailBal_Summary_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        pnlGridHeading.Visible = False
    ...
    Private Sub btnExcel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExport.Click
        ...
        If gridView.Rows.Count > 0 Then
            GiriPosting.GExport.Post(Me.Name, strCompanyName, lblTitle.Text, gridView, GiriPosting.GExport.GExportType.Export, gridHead)
        End If
    End Sub
    ...
    Private Sub gridView_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles gridView.KeyPress
        ...
        ElseIf UCase(e.KeyChar) = "D" Then
            ...
            If gridView.CurrentRow.Index < gridView.RowCount - 2 Then
                ...
                objDetal.cmbAcGroup.Text = gridView.CurrentRow.Cells("ACGRPNAME").Value.ToString
                objDetal.cmbAcName.Text = gridView.CurrentRow.Cells("PARTICULAR").Value.ToString
                objDetal.flag = True
        ...
        ElseIf UCase(e.KeyChar) = "L" Then
            With frmAccountsLedger
                ...
                strSql += " WHERE ACGRPCODE = (SELECT ACGRPCODE FROM " & cnAdminDb & "..ACHEAD WHERE ACNAME = '" & gridView.Rows(gridView.CurrentRow.Index).Cells("ACNAME").Value.ToString & "')"
                .cmbAcGroup.Text = objGPack.GetSqlValue(strSql)
                .cmbAcName.Text = gridView.Rows(gridView.CurrentRow.Index).Cells("ACNAME").Value.ToString
                'For cnt As Integer = 0 To .chkCmbAcName.Items.Count - 1
                '    If .chkCmbAcName.Items(cnt).ToString = gridView.Rows(gridView.CurrentRow.Index).Cells("ACNAME").Value.ToString Then
                '        .chkCmbAcName.SetItemChecked(cnt, True)
                '    End If
                'Next
                '.cmbAcName_MAN.Text = gridView.Rows(gridView.CurrentRow.Index).Cells("ACNAME").Value.ToString
    ...
    Private Sub btnPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        If gridView.Rows.Count > 0 Then
            GiriPosting.GExport.Post(Me.Name, strCompanyName, lblTitle.Text, gridView, GiriPosting.GExport.GExportType.Print, gridHead)
        End If
    End Sub
    ...
    Private Sub Prop_Sets()
        Dim obj As New frmTrailBal_Summary_Properties
        ...
        SetSettingsObj(obj, Me.Name, GetType(frmTrailBal_Summary_Properties))
    End Sub

    Private Sub Prop_Gets()
        Dim obj As New frmTrailBal_Summary_Properties
        GetSettingsObj(obj, Me.Name, GetType(frmTrailBal_Summary_Properties))
...
Public Class frmTrailBal_Summary_Properties
