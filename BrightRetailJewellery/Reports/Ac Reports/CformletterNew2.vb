...
Public Class CformletterNew2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BrighttechRetailJewellery.CformletterNew2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_TINDETAILS() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCformletterNew2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CformletterNew2 = New CformletterNew2()
        rpt.Site = Me.Site
        Return rpt
    End Function
