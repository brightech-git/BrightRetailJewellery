...
Public Class frmSalesPersonPerformance
    ...
    Private Sub frmSalesPersonPerformance_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        cmdcashcounter.Items.Clear()
        cmdcashcounter.Items.Add("ALL")
        'LOAD COMPANY
        ...
        strSql = " SELECT CASHNAME FROM " & cnAdminDb & "..CASHCOUNTER WHERE ISNULL(ACTIVE,'')='Y' ORDER BY CASHNAME"
        objGPack.FillCombo(strSql, cmdcashcounter, False, False)
    ...
    Private Sub btnView_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnView_Search.Click
        Try
            If GetAdmindbSoftValue("RPT_SALESPERFORMANCE_AUTH", "") = "Y" Then
                If Not GiritechPack.Methods.GetRights(_DtUserRights, "frmSalesPersonPerformance", GiritechPack.Methods.RightMode.View, False) Then
            ...
            End If
            If cmdcashcounter.Text <> "" And cmdcashcounter.Text <> "ALL" Then
                strSql += vbCrLf + ",@CASHCOUNTER = '" & cmdcashcounter.Text & "'"
            Else
                strSql += vbCrLf + ",@CASHCOUNTER = ''"
            End If
            dtSalesPerson = New DataTable
            dtSalesPerson.Columns.Add("KEYNO", GetType(Integer))
            dtSalesPerson.Columns("KEYNO").AutoIncrement = True
    ...
    Function funcAddSalesPerson() As Integer
        Try
            ...
            da = New OleDbDataAdapter(strSql, cn)
            da.Fill(dtSales)
            GiritechPack.GlobalMethods.FillCombo(cmbSalesPerson, dtSales, "EMPNAME", , "ALL")
        Catch ex As Exception
            MsgBox(ex.Message + vbCrLf + ex.StackTrace)
        End Try
    End Function
    ...
    Private Sub Prop_Sets()
        ...
        obj.p_cmdcashcounter = cmdcashcounter.Text
    ...
    Private Sub Prop_Gets()
        ...
        cmdcashcounter.Text = obj.p_cmdcashcounter
    ...
    Private Sub ChkDateWise_CheckedChanged_1(sender As Object, e As EventArgs) Handles chkMonthWise.CheckedChanged, ChkDateWise.CheckedChanged
        chkWithSavings.Visible = Not (chkMonthWise.Checked Or ChkDateWise.Checked)
    End Sub
End Class
...
Public Class frmSalesPersonPerformance_Properties
    ...
    Public Property p_cmbMetal() As String
        ...
        End Set
    End Property
    Private cmdcashcounter As String = "ALL"
    Public Property p_cmdcashcounter() As String
        Get
            Return cmdcashcounter
        End Get
        Set(ByVal value As String)
            cmdcashcounter = value
        End Set
    End Property
