...
Public Class frmCreditBalanceReport
    ...
    Private Sub btnExport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExport.Click
        If gridView.RowCount > 0 Then
            GiriPosting.GExport.Post(Me.Name, "", gridView, lblTitle.Text, GiriPosting.GExport.GExportType.Export)
        End If
    End Sub
    ...
    Private Sub btnPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        If gridView.RowCount > 0 Then
            GiriPosting.GExport.Post(Me.Name, "", gridView, lblTitle.Text, GiriPosting.GExport.GExportType.Print)
        End If
    End Sub
    ...
    Private Sub btnView_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnView.Click
        ...
        If cmbAcName_Own.Text = "" Or cmbAcName_Own.Text = "ALL" Then
            ...
            If cmbAccountType.Text <> "" Then
                ...
                End If
            End If
        ElseIf cmbAcName_Own.Text <> "" Then
