...
Public Class frmOtherMaster
    ...
    Function funcCallGrid() As Integer
        strSql = " SELECT ID,NAME,SHORTNAME"
    ...
    Function funcAdd() As Integer
        ...
        strSql += " ("
        strSql += " ID,NAME,SHORTNAME,MISCID,ITEMID,USERID,UPDATED,UPTIME,ACTIVE"
        strSql += " )VALUES("
        strSql += " " & Val(txtPatternId_Num_Man.Text) & "" 'Id
        strSql += " ,'" & txtPatternName__Man.Text & "'" 'Name
        strSql += " ,'" & txtPatternShName.Text & "'" 'SHORTNAME
    ...
    Function funcUpdate() As Integer
        ...
        strSql += " ,SHORTNAME='" & txtPatternShName.Text & "'"
    ...
    Function funcGetDetails(ByVal tempSizeId As Integer) As Integer
        ...
        With dt.Rows(0)
            ...
            txtPatternName__Man.Text = .Item("NAME").ToString
            txtPatternShName.Text = .Item("SHORTNAME").ToString
