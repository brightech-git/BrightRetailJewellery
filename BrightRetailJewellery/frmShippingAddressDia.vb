...
Imports System.IO
Public Class frmShippingAddressDia
    ...
    Public PersonalinfoInsert1 As Boolean = False
    ...
    Dim POS_CUST_IMAGE As Boolean = False ''IIf(GetAdmindbSoftValue("POS_CUST_IMAGE", "N") = "Y", True, False)
...
GETNSNO:
    ...
    Public Sub lockControls(ByVal bool As Boolean)
        ...
        If GetAdmindbSoftValue("ADD_UPDATE_RESTRICT_GST", "N") = "Y" And txtGSTNo.Text.Trim <> "" Then txtGSTNo.ReadOnly = bool
    ...
    Public Function InsertIntoPersonalInfo(ByVal billdate As Date, ByVal billCostId As String, ByVal batchno As String, ByVal tran1 As OleDbTransaction _
        ...
        If PersonalinfoInsert1 = True Then Return ""
        ...
        Else
            ...
            strSql += vbCrLf + ",''"
        End If
        strSql += vbCrLf + " ,'" & batchno.ToString & "'"
        If RELIGION Then
    ...
    Public Sub DeleteAndInsert(ByVal trn As OleDbTransaction)
        InsertIntoPersonalInfo(editBilldate, editCostId, editBatchno, trn,, "")
    ...
    Private Sub txtAddressPan_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtAddressPan.KeyPress
        If e.KeyChar = Chr(Keys.Enter) Then
            If txtAddressPan.Text = "" And PanMand Then
    ...
    Private Sub txtMobile_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtMobile.KeyPress
        ...
        If e.KeyChar = Chr(Keys.Enter) Then
            ...
            strSql += vbCrLf + " ,ADDRESS2,ADDRESS3,AREA,PINCODE,CITY,COUNTRY,PHONERES,MOBILE,IDTYPE,IDNO,GSTNO"
            ...
            Else
                If dtcnt.Rows.Count > 0 Then
                    ...
                    strSql += vbCrLf + " ,ADDRESS3,AREA,PINCODE,CITY,COUNTRY,PHONERES,MOBILE,IDTYPE,IDNO,GSTNO"
            ...
            Else
                ...
                strSql += vbCrLf + " ,RELIGION,GSTNO,DOBIRTH,ANNIVERSARY,EMAILID"
    ...
    End Sub
    Private Sub txtGvNo_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub cmbPlaceOfSupply_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cmbPlaceOfSupply.KeyDown
        If e.KeyCode = Keys.Enter Then
            ''If GstFlag And cmbPlaceOfSupply.Text <> "" Then
            ...
            ''        Exit Sub
            ''    End If
            ''    If cmbPlaceOfSupply.Text = CompanyState And InterBill Then
