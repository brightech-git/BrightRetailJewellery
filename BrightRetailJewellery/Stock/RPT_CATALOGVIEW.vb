...
Public Class RPT_CATALOGVIEW
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BrighttechRetailJewellery.RPT_CATALOGVIEW.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_PAGEHEADER() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRPT_CATALOGVIEW
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_CATALOGVIEW = New RPT_CATALOGVIEW()
        rpt.Site = Me.Site
        Return rpt
    End Function
