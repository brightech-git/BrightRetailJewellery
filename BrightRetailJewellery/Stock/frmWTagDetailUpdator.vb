...
Public Class frmWTagDetailUpdator
    ...
    Private Sub GenRateGrid()
        ...
        End If
        strSql += vbCrLf + "   FROM " & cnAdminDb & "..WITEMTAG T"
    ...
    Private Sub GenStnRateGrid()
        ...
        strSql += vbCrLf + "  ,T.SNO AS TAGSNO FROM " & cnAdminDb & "..WITEMTAG T"
        strSql += vbCrLf + "  INNER JOIN " & cnAdminDb & "..WITEMTAGSTONE AS P ON P.TAGSNO = T.SNO"
    ...
    Private Sub GetOtherGrid()
        ...
        strSql += "  FROM " & cnAdminDb & "..WITEMTAG T"
...
#End Region
    ...
    Private Function GenUpdateQry(ByVal ro As DataRow) As String
        ...
        If cmbMode.Text.ToUpper = "STONERATE" Then
            qry += " UPDATE " & cnAdminDb & "..WITEMTAGSTONE SET"
        ...
        Else
            qry += " UPDATE " & cnAdminDb & "..WITEMTAG SET"
            ...
            ElseIf cmbMode.Text.ToUpper = "TABLE" Then
                ...
                qry += " FROM " & cnAdminDb & "..WITEMTAG A," & cnAdminDb & "..WMCTABLE N "
            ...
            If cmbMode.Text.ToUpper <> "WASTAGE" Then
                qry += " WHERE SNO = '" & ro.Item("SNO").ToString & "'"
            Else
                qry += " FROM " & cnAdminDb & "..WITEMTAG AS T WHERE SNO = '" & ro.Item("SNO").ToString & "'"
            End If
