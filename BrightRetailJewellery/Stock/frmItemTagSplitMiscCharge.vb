...
Public Class frmItemTagSplitMiscCharge
    Dim dtTagDet As New DataTable
    Dim strSql As String
    Public dtMiscDetails As New DataTable("GridMisc")
    Dim tagNo As String = ""
    ...
    End Sub
    Public Sub New(ByVal _tagNo As String, ByVal _itemId As Integer)
        ' This call is required by the Windows Form Designer.
        InitializeComponent()
        tagNo = _tagNo
        itemId = _itemId
...
#End Region
    ...
    Private Sub frmItemTagSplitMiscCharge_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
