...
Public Class rptEstimation
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BrighttechRetailJewellery.rptEstimation.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEstimation
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEstimation = New rptEstimation()
        rpt.Site = Me.Site
        Return rpt
    End Function
