...
Public Class frmSign
    ...
    Private Sub btnOk_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnOk.Click
        ...
        Dim WUrl As String = txtWhatsappUrl.Text
        Dim WOptinUrl As String = txtWhatsappOptinUrl.Text
        ...
        write.WriteLine(LSet("WHATSAPP URL       :", 20) & WUrl)
        write.WriteLine(LSet("WHATSAPP Optin URL :", 20) & WOptinUrl)
        write.Flush()
        write.Close()
    ...
    Public Shared Function Encrypt(ByVal Str_Pwd As String) As String
